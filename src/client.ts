...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STAINLESS18_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STAINLESS18_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Stainless18 API.
 */
export class Stainless18 {
  apiKey: string | null;
  project: string | null;
   ...
   * @param {string} [opts.baseURL=process.env['STAINLESS18_BASE_URL'] ?? https://api.stainless.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('STAINLESS18_BASE_URL'),
    ...
    if (baseURL && opts.environment) {
      throw new Errors.Stainless18Error(
    ...
    this.timeout = options.timeout ?? Stainless18.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('STAINLESS18_LOG'), "process.env['STAINLESS18_LOG']", this) ??
      defaultLogLevel;
  ...
  >(
    ...
    return new Pagination.PagePromise<PageClass, Item>(this as any as Stainless18, request, Page);
  }
  ...
  static Stainless18 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Stainless18Error = Errors.Stainless18Error;
...
Stainless18.Projects = Projects;
Stainless18.Builds = Builds;
Stainless18.Orgs = Orgs;
Stainless18.User = User;

export declare namespace Stainless18 {
