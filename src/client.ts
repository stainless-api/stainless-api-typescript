...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STAINLESS11_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STAINLESS11_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Stainless11 API.
 */
export class Stainless11 {
  apiKey: string | null;
  project: string | null;
   ...
   * @param {string} [opts.baseURL=process.env['STAINLESS11_BASE_URL'] ?? https://api.stainless.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('STAINLESS11_BASE_URL'),
    ...
    if (baseURL && opts.environment) {
      throw new Errors.Stainless11Error(
    ...
    this.timeout = options.timeout ?? Stainless11.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('STAINLESS11_LOG'), "process.env['STAINLESS11_LOG']", this) ??
      defaultLogLevel;
  ...
  >(
    ...
    return new Pagination.PagePromise<PageClass, Item>(this as any as Stainless11, request, Page);
  }
  ...
  static Stainless11 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Stainless11Error = Errors.Stainless11Error;
...
Stainless11.Projects = Projects;
Stainless11.Builds = Builds;
Stainless11.Orgs = Orgs;
Stainless11.User = User;

export declare namespace Stainless11 {
