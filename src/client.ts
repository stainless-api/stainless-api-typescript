...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STAINLESS13_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STAINLESS13_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Stainless13 API.
 */
export class Stainless13 {
  apiKey: string | null;
  project: string | null;
   ...
   * @param {string} [opts.baseURL=process.env['STAINLESS13_BASE_URL'] ?? https://api.stainless.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('STAINLESS13_BASE_URL'),
    ...
    if (baseURL && opts.environment) {
      throw new Errors.Stainless13Error(
    ...
    this.timeout = options.timeout ?? Stainless13.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('STAINLESS13_LOG'), "process.env['STAINLESS13_LOG']", this) ??
      defaultLogLevel;
  ...
  >(
    ...
    return new Pagination.PagePromise<PageClass, Item>(this as any as Stainless13, request, Page);
  }
  ...
  static Stainless13 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Stainless13Error = Errors.Stainless13Error;
...
Stainless13.Projects = Projects;
Stainless13.Builds = Builds;
Stainless13.Orgs = Orgs;
Stainless13.User = User;

export declare namespace Stainless13 {
