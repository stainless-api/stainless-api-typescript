...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STAINLESS5_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STAINLESS5_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Stainless5 API.
 */
export class Stainless5 {
  apiKey: string | null;
  project: string | null;
   ...
   * @param {string} [opts.baseURL=process.env['STAINLESS5_BASE_URL'] ?? https://api.stainless.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('STAINLESS5_BASE_URL'),
    ...
    if (baseURL && opts.environment) {
      throw new Errors.Stainless5Error(
    ...
    this.timeout = options.timeout ?? Stainless5.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('STAINLESS5_LOG'), "process.env['STAINLESS5_LOG']", this) ??
      defaultLogLevel;
  ...
  >(
    ...
    return new Pagination.PagePromise<PageClass, Item>(this as any as Stainless5, request, Page);
  }
  ...
  static Stainless5 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Stainless5Error = Errors.Stainless5Error;
...
Stainless5.Projects = Projects;
Stainless5.Builds = Builds;
Stainless5.Orgs = Orgs;
Stainless5.User = User;

export declare namespace Stainless5 {
