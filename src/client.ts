...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STAINLESS6_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STAINLESS6_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Stainless6 API.
 */
export class Stainless6 {
  apiKey: string | null;
  project: string | null;
   ...
   * @param {string} [opts.baseURL=process.env['STAINLESS6_BASE_URL'] ?? https://api.stainless.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('STAINLESS6_BASE_URL'),
    ...
    if (baseURL && opts.environment) {
      throw new Errors.Stainless6Error(
    ...
    this.timeout = options.timeout ?? Stainless6.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('STAINLESS6_LOG'), "process.env['STAINLESS6_LOG']", this) ??
      defaultLogLevel;
  ...
  >(
    ...
    return new Pagination.PagePromise<PageClass, Item>(this as any as Stainless6, request, Page);
  }
  ...
  static Stainless6 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Stainless6Error = Errors.Stainless6Error;
...
Stainless6.Projects = Projects;
Stainless6.Builds = Builds;
Stainless6.Orgs = Orgs;
Stainless6.User = User;

export declare namespace Stainless6 {
