...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STAINLESS7_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STAINLESS7_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Stainless7 API.
 */
export class Stainless7 {
  apiKey: string | null;
  project: string | null;
   ...
   * @param {string} [opts.baseURL=process.env['STAINLESS7_BASE_URL'] ?? https://api.stainless.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('STAINLESS7_BASE_URL'),
    ...
    if (baseURL && opts.environment) {
      throw new Errors.Stainless7Error(
    ...
    this.timeout = options.timeout ?? Stainless7.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('STAINLESS7_LOG'), "process.env['STAINLESS7_LOG']", this) ??
      defaultLogLevel;
  ...
  >(
    ...
    return new Pagination.PagePromise<PageClass, Item>(this as any as Stainless7, request, Page);
  }
  ...
  static Stainless7 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Stainless7Error = Errors.Stainless7Error;
...
Stainless7.Projects = Projects;
Stainless7.Builds = Builds;
Stainless7.Orgs = Orgs;
Stainless7.User = User;

export declare namespace Stainless7 {
