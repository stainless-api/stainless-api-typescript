...
* add option to get raw openapi spec content, bypassing gcs ([4149d78](https://github.com/stainless-api/stainless-api-typescript/commit/4149d78f35fc09b0356c50cf57e73806229e664c))
* allow direct upload of spec/config to v0 builds api when merging/rebasing ([97a5207](https://github.com/stainless-api/stainless-api-typescript/commit/97a5207d77009b24d225033508f363e4a7525c08))
...
* **api:** manual updates ([9e3aa9a](https://github.com/stainless-api/stainless-api-typescript/commit/9e3aa9abc46be254d0a36d44376e474e627a5621))
* do not require body in rebase api ([dabee82](https://github.com/stainless-api/stainless-api-typescript/commit/dabee82102e2430f98846ab3bbaab73d1f93f32e))
* support setting headers via env ([5dd3dca](https://github.com/stainless-api/stainless-api-typescript/commit/5dd3dca364fb1d22777575b1db552a3747044fe9))


### Bug Fixes

* **client:** send content-type header for requests with an omitted optional body ([9419409](https://github.com/stainless-api/stainless-api-typescript/commit/9419409e9e62fbcac776fe7a0a84d4729dc33174))
...
* avoid formatting file that gets changed during releases ([88cd684](https://github.com/stainless-api/stainless-api-typescript/commit/88cd6842673b1db18d254bbdf7eef58a0ff1a944))
...
* **format:** run eslint and prettier separately ([3f0f01c](https://github.com/stainless-api/stainless-api-typescript/commit/3f0f01c00632bbaffe94082a20d259a1928085af))
* **formatter:** run prettier and eslint separately ([18c0ff0](https://github.com/stainless-api/stainless-api-typescript/commit/18c0ff09d24b6bc67f49c7a48ef1695997f23682))
* **internal:** codegen related update ([6556384](https://github.com/stainless-api/stainless-api-typescript/commit/6556384956d626ba7c502afa8c6daa1c4f089bd4))
* **internal:** codegen related update ([5268a84](https://github.com/stainless-api/stainless-api-typescript/commit/5268a84447076de65fa0df1356c281acf05a9d9d))
* **internal:** codegen related update ([7987423](https://github.com/stainless-api/stainless-api-typescript/commit/7987423c0ff2593c0da7f5b3beeeedeaecb9ea5a))
* **internal:** codegen related update ([f411687](https://github.com/stainless-api/stainless-api-typescript/commit/f411687c0665a65309dd9472dcd9d71b2fdedd5d))
* **internal:** codegen related update ([c1614b4](https://github.com/stainless-api/stainless-api-typescript/commit/c1614b4236cf224d2eeff1219c2f922dc865e837))
...
* restructure docs search code ([2bd2b16](https://github.com/stainless-api/stainless-api-typescript/commit/2bd2b1625b8a9743fe898c64cc95ca8c01410726))
* run formatter on custom code ([#223](https://github.com/stainless-api/stainless-api-typescript/issues/223)) ([a402a26](https://github.com/stainless-api/stainless-api-typescript/commit/a402a26cf8edbc433ada48b5ee97311643c8fd6c))
...
* update logging docs ([f6f76a8](https://github.com/stainless-api/stainless-api-typescript/commit/f6f76a8bf8da098587b745c566467add238f90ee))
