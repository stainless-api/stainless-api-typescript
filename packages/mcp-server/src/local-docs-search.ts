  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.update',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject = stainless10.projects.update(project: "project")\n\nputs(project)',
      },
      typescript: {
        method: 'client.projects.update',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.list',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\npage = stainless10.projects.list\n\nputs(page)',
      },
      typescript: {
        method: 'client.projects.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.create',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject = stainless10.projects.create(\n  display_name: "display_name",\n  org: "org",\n  revision: {foo: {content: "content"}},\n  slug: "slug",\n  targets: [:node]\n)\n\nputs(project)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.generate_commit_message',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nresponse = stainless10.projects.generate_commit_message(\n  project: "project",\n  target: :python,\n  base_ref: "base_ref",\n  head_ref: "head_ref"\n)\n\nputs(response)',
      },
      typescript: {
        method: 'client.projects.generateCommitMessage',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.create',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless10.projects.branches.create(project: "project", branch: "branch", branch_from: "branch_from")\n\nputs(project_branch)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.retrieve',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless10.projects.branches.retrieve("branch", project: "project")\n\nputs(project_branch)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.list',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\npage = stainless10.projects.branches.list(project: "project")\n\nputs(page)',
      },
      typescript: {
        method: 'client.projects.branches.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.delete',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nbranch = stainless10.projects.branches.delete("branch", project: "project")\n\nputs(branch)',
      },
      typescript: {
        method: 'client.projects.branches.delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.rebase',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless10.projects.branches.rebase("branch", project: "project")\n\nputs(project_branch)',
      },
      typescript: {
        method: 'client.projects.branches.rebase',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.reset',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless10.projects.branches.reset("branch", project: "project")\n\nputs(project_branch)',
      },
      typescript: {
        method: 'client.projects.branches.reset',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.configs.retrieve',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nconfig = stainless10.projects.configs.retrieve(project: "project")\n\nputs(config)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.configs.guess',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nresponse = stainless10.projects.configs.guess(project: "project", spec: "spec")\n\nputs(response)',
      },
      typescript: {
        method: 'client.projects.configs.guess',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.list',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\npage = stainless10.builds.list(project: "project")\n\nputs(page)',
      },
      typescript: {
        method: 'client.builds.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.create',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nbuild = stainless10.builds.create(project: "project", revision: "string")\n\nputs(build)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.retrieve',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nbuild = stainless10.builds.retrieve("buildId")\n\nputs(build)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.compare',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nresponse = stainless10.builds.compare(\n  base: {branch: "branch", revision: "string"},\n  head: {branch: "branch", revision: "string"},\n  project: "project"\n)\n\nputs(response)',
      },
      typescript: {
        method: 'client.builds.compare',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.diagnostics.list',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\npage = stainless10.builds.diagnostics.list("buildId")\n\nputs(page)',
      },
      typescript: {
        method: 'client.builds.diagnostics.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.target_outputs.retrieve',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\ntarget_output = stainless10.builds.target_outputs.retrieve(build_id: "build_id", target: :node, type: :source)\n\nputs(target_output)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'orgs.retrieve',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\norg = stainless10.orgs.retrieve("org")\n\nputs(org)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'user.retrieve',
        example:
          'require "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nuser = stainless10.user.retrieve\n\nputs(user)',
      },
      typescript: {
...
const EMBEDDED_READMES: { language: string; content: string }[] = [
  {
    language: 'python',
    content:
      '# Stainless10 Python API library\n\n<!-- prettier-ignore -->\n[![PyPI version](https://img.shields.io/pypi/v/stainless_v0.svg?label=pypi%20(stable))](https://pypi.org/project/stainless_v0/)\n\nThe Stainless10 Python library provides convenient access to the Stainless10 REST API from any Python 3.9+\napplication. The library includes type definitions for all request params and response fields,\nand offers both synchronous and asynchronous clients powered by [httpx](https://github.com/encode/httpx).\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless10 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczEwLnN0bG1jcC5jb20iLCJoZWFkZXJzIjp7Ingtc3RhaW5sZXNzLWFwaS1rZXkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless10.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\n## Documentation\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli). The full API of this library can be found in [api.md](api.md).\n\n## Installation\n\n```sh\n# install from this staging repo\npip install git+ssh://git@github.com/stainless-sdks/stainless10-python.git\n```\n> [!NOTE]\n> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install stainless_v0`\n\n## Usage\n\nThe full API of this library can be found in [api.md](api.md).\n\n```python\nimport os\nfrom stainless_v0 import Stainless10\n\nclient = Stainless10(\n    api_key=os.environ.get("STAINLESS_API_KEY"),  # This is the default and can be omitted\n    # defaults to "production".\n    environment="staging",\n)\n\nbuild = client.builds.create(\n    project="stainless",\n    revision="main",\n)\nprint(build.id)\n```\n\nWhile you can provide an `api_key` keyword argument,\nwe recommend using [python-dotenv](https://pypi.org/project/python-dotenv/)\nto add `STAINLESS_API_KEY="My API Key"` to your `.env` file\nso that your API Key is not stored in source control.\n\n## Async usage\n\nSimply import `AsyncStainless10` instead of `Stainless10` and use `await` with each API call:\n\n```python\nimport os\nimport asyncio\nfrom stainless_v0 import AsyncStainless10\n\nclient = AsyncStainless10(\n    api_key=os.environ.get("STAINLESS_API_KEY"),  # This is the default and can be omitted\n    # defaults to "production".\n    environment="staging",\n)\n\nasync def main() -> None:\n  build = await client.builds.create(\n      project="stainless",\n      revision="main",\n  )\n  print(build.id)\n\nasyncio.run(main())\n```\n\nFunctionality between the synchronous and asynchronous clients is otherwise identical.\n\n### With aiohttp\n\nBy default, the async client uses `httpx` for HTTP requests. However, for improved concurrency performance you may also use `aiohttp` as the HTTP backend.\n\nYou can enable this by installing `aiohttp`:\n\n```sh\n# install from this staging repo\npip install \'stainless_v0[aiohttp] @ git+ssh://git@github.com/stainless-sdks/stainless10-python.git\'\n```\n\nThen you can enable it by instantiating the client with `http_client=DefaultAioHttpClient()`:\n\n```python\nimport os\nimport asyncio\nfrom stainless_v0 import DefaultAioHttpClient\nfrom stainless_v0 import AsyncStainless10\n\nasync def main() -> None:\n  async with AsyncStainless10(\n    api_key=os.environ.get("STAINLESS_API_KEY"),  # This is the default and can be omitted\n    http_client=DefaultAioHttpClient(),\n) as client:\n    build = await client.builds.create(\n        project="stainless",\n        revision="main",\n    )\n    print(build.id)\n\nasyncio.run(main())\n```\n\n\n\n## Using types\n\nNested request parameters are [TypedDicts](https://docs.python.org/3/library/typing.html#typing.TypedDict). Responses are [Pydantic models](https://docs.pydantic.dev) which also provide helper methods for things like:\n\n- Serializing back into JSON, `model.to_json()`\n- Converting to a dictionary, `model.to_dict()`\n\nTyped requests and responses provide autocomplete and documentation within your editor. If you would like to see type errors in VS Code to help catch bugs earlier, set `python.analysis.typeCheckingMode` to `basic`.\n\n## Pagination\n\nList methods in the Stainless10 API are paginated.\n\nThis library provides auto-paginating iterators with each list response, so you do not have to request successive pages manually:\n\n```python\nfrom stainless_v0 import Stainless10\n\nclient = Stainless10()\n\nall_builds = []\n# Automatically fetches more pages as needed.\nfor build in client.builds.list(\n    project="stainless",\n):\n    # Do something with build here\n    all_builds.append(build)\nprint(all_builds)\n```\n\nOr, asynchronously:\n\n```python\nimport asyncio\nfrom stainless_v0 import AsyncStainless10\n\nclient = AsyncStainless10()\n\nasync def main() -> None:\n    all_builds = []\n    # Iterate through items across all pages, issuing requests as needed.\n    async for build in client.builds.list(\n    project="stainless",\n):\n        all_builds.append(build)\n    print(all_builds)\n\nasyncio.run(main())\n```\n\nAlternatively, you can use the `.has_next_page()`, `.next_page_info()`, or  `.get_next_page()` methods for more granular control working with pages:\n\n```python\nfirst_page = await client.builds.list(\n    project="stainless",\n)\nif first_page.has_next_page():\n    print(f"will fetch next page using these details: {first_page.next_page_info()}")\n    next_page = await first_page.get_next_page()\n    print(f"number of items we just fetched: {len(next_page.data)}")\n\n# Remove `await` for non-async usage.\n```\n\nOr just work directly with the returned data:\n\n```python\nfirst_page = await client.builds.list(\n    project="stainless",\n)\n\nprint(f"next page cursor: {first_page.next_cursor}") # => "next page cursor: ..."\nfor build in first_page.data:\n    print(build.id)\n\n# Remove `await` for non-async usage.\n```\n\n## Nested params\n\nNested parameters are dictionaries, typed using `TypedDict`, for example:\n\n```python\nfrom stainless_v0 import Stainless10\n\nclient = Stainless10()\n\nbuild = client.builds.create(\n    project="project",\n    revision="string",\n    target_commit_messages={},\n)\nprint(build.target_commit_messages)\n```\n\n\n\n## Handling errors\n\nWhen the library is unable to connect to the API (for example, due to network connection problems or a timeout), a subclass of `stainless_v0.APIConnectionError` is raised.\n\nWhen the API returns a non-success status code (that is, 4xx or 5xx\nresponse), a subclass of `stainless_v0.APIStatusError` is raised, containing `status_code` and `response` properties.\n\nAll errors inherit from `stainless_v0.APIError`.\n\n```python\nimport stainless_v0\nfrom stainless_v0 import Stainless10\n\nclient = Stainless10()\n\ntry:\n    client.builds.create(\n        project="stainless",\n        revision="main",\n    )\nexcept stainless_v0.APIConnectionError as e:\n    print("The server could not be reached")\n    print(e.__cause__) # an underlying Exception, likely raised within httpx.\nexcept stainless_v0.RateLimitError as e:\n    print("A 429 status code was received; we should back off a bit.")\nexcept stainless_v0.APIStatusError as e:\n    print("Another non-200-range status code was received")\n    print(e.status_code)\n    print(e.response)\n```\n\nError codes are as follows:\n\n| Status Code | Error Type                 |\n| ----------- | -------------------------- |\n| 400         | `BadRequestError`          |\n| 401         | `AuthenticationError`      |\n| 403         | `PermissionDeniedError`    |\n| 404         | `NotFoundError`            |\n| 422         | `UnprocessableEntityError` |\n| 429         | `RateLimitError`           |\n| >=500       | `InternalServerError`      |\n| N/A         | `APIConnectionError`       |\n\n### Retries\n\nCertain errors are automatically retried 2 times by default, with a short exponential backoff.\nConnection errors (for example, due to a network connectivity problem), 408 Request Timeout, 409 Conflict,\n429 Rate Limit, and >=500 Internal errors are all retried by default.\n\nYou can use the `max_retries` option to configure or disable retry settings:\n\n```python\nfrom stainless_v0 import Stainless10\n\n# Configure the default for all requests:\nclient = Stainless10(\n    # default is 2\n    max_retries=0,\n)\n\n# Or, configure per-request:\nclient.with_options(max_retries = 5).builds.create(\n    project="stainless",\n    revision="main",\n)\n```\n\n### Timeouts\n\nBy default requests time out after 1 minute. You can configure this with a `timeout` option,\nwhich accepts a float or an [`httpx.Timeout`](https://www.python-httpx.org/advanced/timeouts/#fine-tuning-the-configuration) object:\n\n```python\nfrom stainless_v0 import Stainless10\n\n# Configure the default for all requests:\nclient = Stainless10(\n    # 20 seconds (default is 1 minute)\n    timeout=20.0,\n)\n\n# More granular control:\nclient = Stainless10(\n    timeout=httpx.Timeout(60.0, read=5.0, write=10.0, connect=2.0),\n)\n\n# Override per-request:\nclient.with_options(timeout = 5.0).builds.create(\n    project="stainless",\n    revision="main",\n)\n```\n\nOn timeout, an `APITimeoutError` is thrown.\n\nNote that requests that time out are [retried twice by default](#retries).\n\n\n\n## Advanced\n\n### Logging\n\nWe use the standard library [`logging`](https://docs.python.org/3/library/logging.html) module.\n\nYou can enable logging by setting the environment variable `STAINLESS10_LOG` to `info`.\n\n```shell\n$ export STAINLESS10_LOG=info\n```\n\nOr to `debug` for more verbose logging.\n\n### How to tell whether `None` means `null` or missing\n\nIn an API response, a field may be explicitly `null`, or missing entirely; in either case, its value is `None` in this library. You can differentiate the two cases with `.model_fields_set`:\n\n```py\nif response.my_field is None:\n  if \'my_field\' not in response.model_fields_set:\n    print(\'Got json like {}, without a "my_field" key present at all.\')\n  else:\n    print(\'Got json like {"my_field": null}.\')\n```\n\n### Accessing raw response data (e.g. headers)\n\nThe "raw" Response object can be accessed by prefixing `.with_raw_response.` to any HTTP method call, e.g.,\n\n```py\nfrom stainless_v0 import Stainless10\n\nclient = Stainless10()\nresponse = client.builds.with_raw_response.create(\n    project="stainless",\n    revision="main",\n)\nprint(response.headers.get(\'X-My-Header\'))\n\nbuild = response.parse()  # get the object that `builds.create()` would have returned\nprint(build.id)\n```\n\nThese methods return an [`APIResponse`](https://github.com/stainless-sdks/stainless10-python/tree/main/src/stainless_v0/_response.py) object.\n\nThe async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/stainless10-python/tree/main/src/stainless_v0/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.\n\n#### `.with_streaming_response`\n\nThe above interface eagerly reads the full response body when you make the request, which may not always be what you want.\n\nTo stream the response body, use `.with_streaming_response` instead, which requires a context manager and only reads the response body once you call `.read()`, `.text()`, `.json()`, `.iter_bytes()`, `.iter_text()`, `.iter_lines()` or `.parse()`. In the async client, these are async methods.\n\n```python\nwith client.builds.with_streaming_response.create(\n    project="stainless",\n    revision="main",\n) as response :\n    print(response.headers.get(\'X-My-Header\'))\n\n    for line in response.iter_lines():\n      print(line)\n```\n\nThe context manager is required so that the response will reliably be closed.\n\n### Making custom/undocumented requests\n\nThis library is typed for convenient access to the documented API.\n\nIf you need to access undocumented endpoints, params, or response properties, the library can still be used.\n\n#### Undocumented endpoints\n\nTo make requests to undocumented endpoints, you can make requests using `client.get`, `client.post`, and other\nhttp verbs. Options on the client will be respected (such as retries) when making this request.\n\n```py\nimport httpx\n\nresponse = client.post(\n    "/foo",\n    cast_to=httpx.Response,\n    body={"my_param": True},\n)\n\nprint(response.headers.get("x-foo"))\n```\n\n#### Undocumented request params\n\nIf you want to explicitly send an extra param, you can do so with the `extra_query`, `extra_body`, and `extra_headers` request\noptions.\n\n#### Undocumented response properties\n\nTo access undocumented response properties, you can access the extra fields like `response.unknown_prop`. You\ncan also get all the extra fields on the Pydantic model as a dict with\n[`response.model_extra`](https://docs.pydantic.dev/latest/api/base_model/#pydantic.BaseModel.model_extra).\n\n### Configuring the HTTP client\n\nYou can directly override the [httpx client](https://www.python-httpx.org/api/#client) to customize it for your use case, including:\n\n- Support for [proxies](https://www.python-httpx.org/advanced/proxies/)\n- Custom [transports](https://www.python-httpx.org/advanced/transports/)\n- Additional [advanced](https://www.python-httpx.org/advanced/clients/) functionality\n\n```python\nimport httpx\nfrom stainless_v0 import Stainless10, DefaultHttpxClient\n\nclient = Stainless10(\n    # Or use the `STAINLESS10_BASE_URL` env var\n    base_url="http://my.test.server.example.com:8083",\n    http_client=DefaultHttpxClient(proxy="http://my.test.proxy.example.com", transport=httpx.HTTPTransport(local_address="0.0.0.0")),\n)\n```\n\nYou can also customize the client on a per-request basis by using `with_options()`:\n\n```python\nclient.with_options(http_client=DefaultHttpxClient(...))\n```\n\n### Managing HTTP resources\n\nBy default the library closes underlying HTTP connections whenever the client is [garbage collected](https://docs.python.org/3/reference/datamodel.html#object.__del__). You can manually close the client using the `.close()` method if desired, or with a context manager that closes when exiting.\n\n```py\nfrom stainless_v0 import Stainless10\n\nwith Stainless10() as client:\n  # make requests here\n  ...\n\n# HTTP client is now closed\n```\n\n## Versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes that only affect static types, without breaking runtime behavior.\n2. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n3. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/stainless10-python/issues) with questions, bugs, or suggestions.\n\n### Determining the installed version\n\nIf you\'ve upgraded to the latest version but aren\'t seeing any new features you were expecting then your python environment is likely still using an older version.\n\nYou can determine the version that is being used at runtime with:\n\n```py\nimport stainless_v0\nprint(stainless_v0.__version__)\n```\n\n## Requirements\n\nPython 3.9 or higher.\n\n## Contributing\n\nSee [the contributing documentation](./CONTRIBUTING.md).\n',
  },
  {
    language: 'go',
    content:
      '# Stainless10 Go API Library\n\n<a href="https://pkg.go.dev/github.com/stainless-api/stainless-api-go"><img src="https://pkg.go.dev/badge/github.com/stainless-api/stainless-api-go.svg" alt="Go Reference"></a>\n\nThe Stainless10 Go library provides convenient access to the [Stainless10 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli)\nfrom applications written in Go.\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless10 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczEwLnN0bG1jcC5jb20iLCJoZWFkZXJzIjp7Ingtc3RhaW5sZXNzLWFwaS1rZXkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless10.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\n## Installation\n\n<!-- x-release-please-start-version -->\n\n```go\nimport (\n\t"github.com/stainless-api/stainless-api-go" // imported as SDK_PackageName\n)\n```\n\n<!-- x-release-please-end -->\n\nOr to pin the version:\n\n<!-- x-release-please-start-version -->\n\n```sh\ngo get -u \'github.com/stainless-api/stainless-api-go@v0.0.1\'\n```\n\n<!-- x-release-please-end -->\n\n## Requirements\n\nThis library requires Go 1.22+.\n\n## Usage\n\nThe full API of this library can be found in [api.md](api.md).\n\n```go\npackage main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-api/stainless-api-go"\n\t"github.com/stainless-api/stainless-api-go/option"\n)\n\nfunc main() {\n\tclient := stainless.NewClient(\n\t\toption.WithAPIKey("My API Key"), // defaults to os.LookupEnv("STAINLESS_API_KEY")\n\t\toption.WithEnvironmentStaging(), // defaults to option.WithEnvironmentProduction()\n\t)\n\tbuild, err := client.Builds.New(context.TODO(), stainless.BuildNewParams{\n\t\tProject: stainless.String("stainless"),\n\t\tRevision: stainless.BuildNewParamsRevisionUnion{\n\t\t\tOfString: stainless.String("main"),\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", build.ID)\n}\n\n```\n\n### Request fields\n\nAll request parameters are wrapped in a generic `Field` type,\nwhich we use to distinguish zero values from null or omitted fields.\n\nThis prevents accidentally sending a zero value if you forget a required parameter,\nand enables explicitly sending `null`, `false`, `\'\'`, or `0` on optional parameters.\nAny field not specified is not sent.\n\nTo construct fields with values, use the helpers `String()`, `Int()`, `Float()`, or most commonly, the generic `F[T]()`.\nTo send a null, use `Null[T]()`, and to send a nonconforming value, use `Raw[T](any)`. For example:\n\n```go\nparams := FooParams{\n\tName: SDK_PackageName.F("hello"),\n\n\t// Explicitly send `"description": null`\n\tDescription: SDK_PackageName.Null[string](),\n\n\tPoint: SDK_PackageName.F(SDK_PackageName.Point{\n\t\tX: SDK_PackageName.Int(0),\n\t\tY: SDK_PackageName.Int(1),\n\n\t\t// In cases where the API specifies a given type,\n\t\t// but you want to send something else, use `Raw`:\n\t\tZ: SDK_PackageName.Raw[int64](0.01), // sends a float\n\t}),\n}\n```\n\n### Response objects\n\nAll fields in response structs are value types (not pointers or wrappers).\n\nIf a given field is `null`, not present, or invalid, the corresponding field\nwill simply be its zero value.\n\nAll response structs also include a special `JSON` field, containing more detailed\ninformation about each property, which you can use like so:\n\n```go\nif res.Name == "" {\n\t// true if `"name"` is either not present or explicitly null\n\tres.JSON.Name.IsNull()\n\n\t// true if the `"name"` key was not present in the response JSON at all\n\tres.JSON.Name.IsMissing()\n\n\t// When the API returns data that cannot be coerced to the expected type:\n\tif res.JSON.Name.IsInvalid() {\n\t\traw := res.JSON.Name.Raw()\n\n\t\tlegacyName := struct{\n\t\t\tFirst string `json:"first"`\n\t\t\tLast  string `json:"last"`\n\t\t}{}\n\t\tjson.Unmarshal([]byte(raw), &legacyName)\n\t\tname = legacyName.First + " " + legacyName.Last\n\t}\n}\n```\n\nThese `.JSON` structs also include an `Extras` map containing\nany properties in the json response that were not specified\nin the struct. This can be useful for API features not yet\npresent in the SDK.\n\n```go\nbody := res.JSON.ExtraFields["my_unexpected_field"].Raw()\n```\n\n### RequestOptions\n\nThis library uses the functional options pattern. Functions defined in the\n`SDK_PackageOptionName` package return a `RequestOption`, which is a closure that mutates a\n`RequestConfig`. These options can be supplied to the client or at individual\nrequests. For example:\n\n```go\nclient := SDK_PackageName.SDK_ClientInitializerName(\n\t// Adds a header to every request made by the client\n\tSDK_PackageOptionName.WithHeader("X-Some-Header", "custom_header_info"),\n)\n\nclient.Builds.New(context.TODO(), ...,\n\t// Override the header\n\tSDK_PackageOptionName.WithHeader("X-Some-Header", "some_other_custom_header_info"),\n\t// Add an undocumented field to the request body, using sjson syntax\n\tSDK_PackageOptionName.WithJSONSet("some.json.path", map[string]string{"my": "object"}),\n)\n```\n\nSee the [full list of request options](https://pkg.go.dev/github.com/stainless-api/stainless-api-go/SDK_PackageOptionName).\n\n### Pagination\n\nThis library provides some conveniences for working with paginated list endpoints.\n\nYou can use `.ListAutoPaging()` methods to iterate through items across all pages:\n\n```go\niter := client.Builds.ListAutoPaging(context.TODO(), stainless.BuildListParams{\n\tProject: stainless.String("stainless"),\n})\n// Automatically fetches more pages as needed.\nfor iter.Next() {\n\tbuild := iter.Current()\n\tfmt.Printf("%+v\\n", build)\n}\nif err := iter.Err(); err != nil {\n\tpanic(err.Error())\n}\n```\n\nOr you can use simple `.List()` methods to fetch a single page and receive a standard response object\nwith additional helper methods like `.GetNextPage()`, e.g.:\n\n```go\npage, err := client.Builds.List(context.TODO(), stainless.BuildListParams{\n\tProject: stainless.String("stainless"),\n})\nfor page != nil {\n\tfor _, build := range page.Data {\n\t\tfmt.Printf("%+v\\n", build)\n\t}\n\tpage, err = page.GetNextPage()\n}\nif err != nil {\n\tpanic(err.Error())\n}\n```\n\n### Errors\n\nWhen the API returns a non-success status code, we return an error with type\n`*SDK_PackageName.Error`. This contains the `StatusCode`, `*http.Request`, and\n`*http.Response` values of the request, as well as the JSON of the error body\n(much like other response objects in the SDK).\n\nTo handle errors, we recommend that you use the `errors.As` pattern:\n\n```go\n_, err := client.Builds.New(context.TODO(), stainless.BuildNewParams{\n\tProject: stainless.String("stainless"),\n\tRevision: stainless.BuildNewParamsRevisionUnion{\n\t\tOfString: stainless.String("main"),\n\t},\n})\nif err != nil {\n\tvar apierr *stainless.Error\n\tif errors.As(err, &apierr) {\n\t\tprintln(string(apierr.DumpRequest(true)))  // Prints the serialized HTTP request\n\t\tprintln(string(apierr.DumpResponse(true))) // Prints the serialized HTTP response\n\t}\n\tpanic(err.Error()) // GET "/v0/builds": 400 Bad Request { ... }\n}\n```\n\nWhen other errors occur, they are returned unwrapped; for example,\nif HTTP transport fails, you might receive `*url.Error` wrapping `*net.OpError`.\n\n### Timeouts\n\nRequests do not time out by default; use context to configure a timeout for a request lifecycle.\n\nNote that if a request is [retried](#retries), the context timeout does not start over.\nTo set a per-retry timeout, use `SDK_PackageOptionName.WithRequestTimeout()`.\n\n```go\n// This sets the timeout for the request, including all the retries.\nctx, cancel := context.WithTimeout(context.Background(), 5*time.Minute)\ndefer cancel()\nclient.Builds.New(\n\tctx,\n\tstainless.BuildNewParams{\n\t\tProject: stainless.String("stainless"),\n\t\tRevision: stainless.BuildNewParamsRevisionUnion{\n\t\t\tOfString: stainless.String("main"),\n\t\t},\n\t},\n\t// This sets the per-retry timeout\n\toption.WithRequestTimeout(20*time.Second),\n)\n```\n\n### File uploads\n\nRequest parameters that correspond to file uploads in multipart requests are typed as\n`param.Field[io.Reader]`. The contents of the `io.Reader` will by default be sent as a multipart form\npart with the file name of "anonymous_file" and content-type of "application/octet-stream".\n\nThe file name and content-type can be customized by implementing `Name() string` or `ContentType()\nstring` on the run-time type of `io.Reader`. Note that `os.File` implements `Name() string`, so a\nfile returned by `os.Open` will be sent with the file name on disk.\n\nWe also provide a helper `SDK_PackageName.FileParam(reader io.Reader, filename string, contentType string)`\nwhich can be used to wrap any `io.Reader` with the appropriate file name and content type.\n\n\n\n### Retries\n\nCertain errors will be automatically retried 2 times by default, with a short exponential backoff.\nWe retry by default all connection errors, 408 Request Timeout, 409 Conflict, 429 Rate Limit,\nand >=500 Internal errors.\n\nYou can use the `WithMaxRetries` option to configure or disable this:\n\n```go\n// Configure the default for all requests:\nclient := stainless.NewClient(\n\toption.WithMaxRetries(0), // default is 2\n)\n\n// Override per-request:\nclient.Builds.New(\n\tcontext.TODO(),\n\tstainless.BuildNewParams{\n\t\tProject: stainless.String("stainless"),\n\t\tRevision: stainless.BuildNewParamsRevisionUnion{\n\t\t\tOfString: stainless.String("main"),\n\t\t},\n\t},\n\toption.WithMaxRetries(5),\n)\n```\n\n\n### Accessing raw response data (e.g. response headers)\n\nYou can access the raw HTTP response data by using the `option.WithResponseInto()` request option. This is useful when\nyou need to examine response headers, status codes, or other details.\n\n```go\n// Create a variable to store the HTTP response\nvar response *http.Response\nbuild, err := client.Builds.New(\n\tcontext.TODO(),\n\tstainless.BuildNewParams{\n\t\tProject: stainless.String("stainless"),\n\t\tRevision: stainless.BuildNewParamsRevisionUnion{\n\t\t\tOfString: stainless.String("main"),\n\t\t},\n\t},\n\toption.WithResponseInto(&response),\n)\nif err != nil {\n\t// handle error\n}\nfmt.Printf("%+v\\n", build)\n\nfmt.Printf("Status Code: %d\\n", response.StatusCode)\nfmt.Printf("Headers: %+#v\\n", response.Header)\n```\n\n### Making custom/undocumented requests\n\nThis library is typed for convenient access to the documented API. If you need to access undocumented\nendpoints, params, or response properties, the library can still be used.\n\n#### Undocumented endpoints\n\nTo make requests to undocumented endpoints, you can use `client.Get`, `client.Post`, and other HTTP verbs.\n`RequestOptions` on the client, such as retries, will be respected when making these requests.\n\n```go\nvar (\n    // params can be an io.Reader, a []byte, an encoding/json serializable object,\n    // or a "…Params" struct defined in this library.\n    params map[string]interface{}\n\n    // result can be an []byte, *http.Response, a encoding/json deserializable object,\n    // or a model defined in this library.\n    result *http.Response\n)\nerr := client.Post(context.Background(), "/unspecified", params, &result)\nif err != nil {\n    …\n}\n```\n\n#### Undocumented request params\n\nTo make requests using undocumented parameters, you may use either the `SDK_PackageOptionName.WithQuerySet()`\nor the `SDK_PackageOptionName.WithJSONSet()` methods.\n\n```go\nparams := FooNewParams{\n    ID:   SDK_PackageName.F("id_xxxx"),\n    Data: SDK_PackageName.F(FooNewParamsData{\n        FirstName: SDK_PackageName.F("John"),\n    }),\n}\nclient.Foo.New(context.Background(), params, SDK_PackageOptionName.WithJSONSet("data.last_name", "Doe"))\n```\n\n#### Undocumented response properties\n\nTo access undocumented response properties, you may either access the raw JSON of the response as a string\nwith `result.JSON.RawJSON()`, or get the raw JSON of a particular field on the result with\n`result.JSON.Foo.Raw()`.\n\nAny fields that are not present on the response struct will be saved and can be accessed by `result.JSON.ExtraFields()` which returns the extra fields as a `map[string]Field`.\n\n### Middleware\n\nWe provide `SDK_PackageOptionName.WithMiddleware` which applies the given\nmiddleware to requests.\n\n```go\nfunc Logger(req *http.Request, next SDK_PackageOptionName.MiddlewareNext) (res *http.Response, err error) {\n\t// Before the request\n\tstart := time.Now()\n\tLogReq(req)\n\n\t// Forward the request to the next handler\n\tres, err = next(req)\n\n\t// Handle stuff after the request\n\tend := time.Now()\n\tLogRes(res, err, start - end)\n\n    return res, err\n}\n\nclient := SDK_PackageName.SDK_ClientInitializerName(\n\tSDK_PackageOptionName.WithMiddleware(Logger),\n)\n```\n\nWhen multiple middlewares are provided as variadic arguments, the middlewares\nare applied left to right. If `SDK_PackageOptionName.WithMiddleware` is given\nmultiple times, for example first in the client then the method, the\nmiddleware in the client will run first and the middleware given in the method\nwill run next.\n\nYou may also replace the default `http.Client` with\n`SDK_PackageOptionName.WithHTTPClient(client)`. Only one http client is\naccepted (this overwrites any previous client) and receives requests after any\nmiddleware has been applied.\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n2. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-api/stainless-api-go/issues) with questions, bugs, or suggestions.\n\n## Contributing\n\nSee [the contributing documentation](./CONTRIBUTING.md).\n',
  },
  {
    language: 'typescript',
    content:
      "# Stainless10 TypeScript API Library\n\n[![NPM version](https://img.shields.io/npm/v/@stainless-api/sdk.svg?label=npm%20(stable))](https://npmjs.org/package/@stainless-api/sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@stainless-api/sdk)\n\nThis library provides convenient access to the Stainless10 REST API from server-side TypeScript or JavaScript.\n\n\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli). The full API of this library can be found in [api.md](api.md).\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless10 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczEwLnN0bG1jcC5jb20iLCJoZWFkZXJzIjp7Ingtc3RhaW5sZXNzLWFwaS1rZXkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless10.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\n## Installation\n\n```sh\nnpm install @stainless-api/sdk\n```\n\n\n\n## Usage\n\nThe full API of this library can be found in [api.md](api.md).\n\n<!-- prettier-ignore -->\n```js\nimport Stainless10 from '@stainless-api/sdk';\n\nconst client = new Stainless10({\n  apiKey: process.env['STAINLESS_API_KEY'], // This is the default and can be omitted\n  environment: 'staging', // defaults to 'production'\n});\n\nconst build = await client.builds.create({ project: 'stainless', revision: 'main' });\n\nconsole.log(build.id);\n```\n\n\n\n### Request & Response types\n\nThis library includes TypeScript definitions for all request params and response fields. You may import and use them like so:\n\n<!-- prettier-ignore -->\n```ts\nimport Stainless10 from '@stainless-api/sdk';\n\nconst client = new Stainless10({\n  apiKey: process.env['STAINLESS_API_KEY'], // This is the default and can be omitted\n  environment: 'staging', // defaults to 'production'\n});\n\nconst params: Stainless10.BuildCreateParams = { project: 'stainless', revision: 'main' };\nconst build: Stainless10.Build = await client.builds.create(params);\n```\n\nDocumentation for each method, request param, and response field are available in docstrings and will appear on hover in most modern editors.\n\n\n\n\n\n## Handling errors\n\nWhen the library is unable to connect to the API,\nor if the API returns a non-success status code (i.e., 4xx or 5xx response),\na subclass of `APIError` will be thrown:\n\n<!-- prettier-ignore -->\n```ts\nconst build = await client.builds\n  .create({ project: 'stainless', revision: 'main' })\n  .catch(async (err) => {\n    if (err instanceof Stainless10.APIError) {\n      console.log(err.status); // 400\n      console.log(err.name); // BadRequestError\n      console.log(err.headers); // {server: 'nginx', ...}\n    } else {\n      throw err;\n    }\n  });\n```\n\nError codes are as follows:\n\n| Status Code | Error Type                 |\n| ----------- | -------------------------- |\n| 400         | `BadRequestError`          |\n| 401         | `AuthenticationError`      |\n| 403         | `PermissionDeniedError`    |\n| 404         | `NotFoundError`            |\n| 422         | `UnprocessableEntityError` |\n| 429         | `RateLimitError`           |\n| >=500       | `InternalServerError`      |\n| N/A         | `APIConnectionError`       |\n\n### Retries\n\nCertain errors will be automatically retried 2 times by default, with a short exponential backoff.\nConnection errors (for example, due to a network connectivity problem), 408 Request Timeout, 409 Conflict,\n429 Rate Limit, and >=500 Internal errors will all be retried by default.\n\nYou can use the `maxRetries` option to configure or disable this:\n\n<!-- prettier-ignore -->\n```js\n// Configure the default for all requests:\nconst client = new Stainless10({\n  maxRetries: 0, // default is 2\n});\n\n// Or, configure per-request:\nawait client.builds.create({ project: 'stainless', revision: 'main' }, {\n  maxRetries: 5,\n});\n```\n\n### Timeouts\n\nRequests time out after 1 minute by default. You can configure this with a `timeout` option:\n\n<!-- prettier-ignore -->\n```ts\n// Configure the default for all requests:\nconst client = new Stainless10({\n  timeout: 20 * 1000, // 20 seconds (default is 1 minute)\n});\n\n// Override per-request:\nawait client.builds.create({ project: 'stainless', revision: 'main' }, {\n  timeout: 5 * 1000,\n});\n```\n\nOn timeout, an `APIConnectionTimeoutError` is thrown.\n\nNote that requests which time out will be [retried twice by default](#retries).\n\n## Auto-pagination\n\nList methods in the Stainless10 API are paginated.\nYou can use the `for await … of` syntax to iterate through items across all pages:\n\n```ts\nasync function fetchAllBuilds(params) {\n  const allBuilds = [];\n  // Automatically fetches more pages as needed.\n  for await (const build of client.builds.list({ project: 'stainless' })) {\n    allBuilds.push(build);\n  }\n  return allBuilds;\n}\n```\n\nAlternatively, you can request a single page at a time:\n\n```ts\nlet page = await client.builds.list({ project: 'stainless' });\nfor (const build of page.data) {\n  console.log(build);\n}\n\n// Convenience methods are provided for manually paginating:\nwhile (page.hasNextPage()) {\n  page = await page.getNextPage();\n  // ...\n}\n```\n\n\n\n## Advanced Usage\n\n### Accessing raw Response data (e.g., headers)\n\nThe \"raw\" `Response` returned by `fetch()` can be accessed through the `.asResponse()` method on the `APIPromise` type that all methods return.\nThis method returns as soon as the headers for a successful response are received and does not consume the response body, so you are free to write custom parsing or streaming logic.\n\nYou can also use the `.withResponse()` method to get the raw `Response` along with the parsed data.\nUnlike `.asResponse()` this method consumes the body, returning once it is parsed.\n\n<!-- prettier-ignore -->\n```ts\nconst client = new Stainless10();\n\nconst response = await client.builds\n  .create({ project: 'stainless', revision: 'main' })\n  .asResponse();\nconsole.log(response.headers.get('X-My-Header'));\nconsole.log(response.statusText); // access the underlying Response object\n\nconst { data: build, response: raw } = await client.builds\n  .create({ project: 'stainless', revision: 'main' })\n  .withResponse();\nconsole.log(raw.headers.get('X-My-Header'));\nconsole.log(build.id);\n```\n\n### Logging\n\n> [!IMPORTANT]\n> All log messages are intended for debugging only. The format and content of log messages\n> may change between releases.\n\n#### Log levels\n\nThe log level can be configured in two ways:\n\n1. Via the `STAINLESS10_LOG` environment variable\n2. Using the `logLevel` client option (overrides the environment variable if set)\n\n```ts\nimport Stainless10 from '@stainless-api/sdk';\n\nconst client = new Stainless10({\n  logLevel: 'debug', // Show all log messages\n});\n```\n\nAvailable log levels, from most to least verbose:\n\n- `'debug'` - Show debug messages, info, warnings, and errors\n- `'info'` - Show info messages, warnings, and errors\n- `'warn'` - Show warnings and errors (default)\n- `'error'` - Show only errors\n- `'off'` - Disable all logging\n\nAt the `'debug'` level, all HTTP requests and responses are logged, including headers and bodies.\nSome authentication-related headers are redacted, but sensitive data in request and response bodies\nmay still be visible.\n\n#### Custom logger\n\nBy default, this library logs to `globalThis.console`. You can also provide a custom logger.\nMost logging libraries are supported, including [pino](https://www.npmjs.com/package/pino), [winston](https://www.npmjs.com/package/winston), [bunyan](https://www.npmjs.com/package/bunyan), [consola](https://www.npmjs.com/package/consola), [signale](https://www.npmjs.com/package/signale), and [@std/log](https://jsr.io/@std/log). If your logger doesn't work, please open an issue.\n\nWhen providing a custom logger, the `logLevel` option still controls which messages are emitted, messages\nbelow the configured level will not be sent to your logger.\n\n```ts\nimport Stainless10 from '@stainless-api/sdk';\nimport pino from 'pino';\n\nconst logger = pino();\n\nconst client = new Stainless10({\n  logger: logger.child({ name: 'Stainless10' }),\n  logLevel: 'debug', // Send all messages to pino, allowing it to filter\n});\n```\n\n### Making custom/undocumented requests\n\nThis library is typed for convenient access to the documented API. If you need to access undocumented\nendpoints, params, or response properties, the library can still be used.\n\n#### Undocumented endpoints\n\nTo make requests to undocumented endpoints, you can use `client.get`, `client.post`, and other HTTP verbs.\nOptions on the client, such as retries, will be respected when making these requests.\n\n```ts\nawait client.post('/some/path', {\n  body: { some_prop: 'foo' },\n  query: { some_query_arg: 'bar' },\n});\n```\n\n#### Undocumented request params\n\nTo make requests using undocumented parameters, you may use `// @ts-expect-error` on the undocumented\nparameter. This library doesn't validate at runtime that the request matches the type, so any extra values you\nsend will be sent as-is.\n\n```ts\nclient.builds.create({\n  // ...\n  // @ts-expect-error baz is not yet public\n  baz: 'undocumented option',\n});\n```\n\nFor requests with the `GET` verb, any extra params will be in the query, all other requests will send the\nextra param in the body.\n\nIf you want to explicitly send an extra argument, you can do so with the `query`, `body`, and `headers` request\noptions.\n\n#### Undocumented response properties\n\nTo access undocumented response properties, you may access the response object with `// @ts-expect-error` on\nthe response object, or cast the response object to the requisite type. Like the request params, we do not\nvalidate or strip extra properties from the response from the API.\n\n### Customizing the fetch client\n\nBy default, this library expects a global `fetch` function is defined.\n\nIf you want to use a different `fetch` function, you can either polyfill the global:\n\n```ts\nimport fetch from 'my-fetch';\n\nglobalThis.fetch = fetch;\n```\n\nOr pass it to the client:\n\n```ts\nimport Stainless10 from '@stainless-api/sdk';\nimport fetch from 'my-fetch';\n\nconst client = new Stainless10({ fetch });\n```\n\n### Fetch options\n\nIf you want to set custom `fetch` options without overriding the `fetch` function, you can provide a `fetchOptions` object when instantiating the client or making a request. (Request-specific options override client options.)\n\n```ts\nimport Stainless10 from '@stainless-api/sdk';\n\nconst client = new Stainless10({\n  fetchOptions: {\n    // `RequestInit` options\n  },\n});\n```\n\n#### Configuring proxies\n\nTo modify proxy behavior, you can provide custom `fetchOptions` that add runtime-specific proxy\noptions to requests:\n\n<img src=\"https://raw.githubusercontent.com/stainless-api/sdk-assets/refs/heads/main/node.svg\" align=\"top\" width=\"18\" height=\"21\"> **Node** <sup>[[docs](https://github.com/nodejs/undici/blob/main/docs/docs/api/ProxyAgent.md#example---proxyagent-with-fetch)]</sup>\n\n```ts\nimport Stainless10 from '@stainless-api/sdk';\nimport * as undici from 'undici';\n\nconst proxyAgent = new undici.ProxyAgent('http://localhost:8888');\nconst client = new Stainless10({\n  fetchOptions: {\n    dispatcher: proxyAgent,\n  },\n});\n```\n\n<img src=\"https://raw.githubusercontent.com/stainless-api/sdk-assets/refs/heads/main/bun.svg\" align=\"top\" width=\"18\" height=\"21\"> **Bun** <sup>[[docs](https://bun.sh/guides/http/proxy)]</sup>\n\n```ts\nimport Stainless10 from '@stainless-api/sdk';\n\nconst client = new Stainless10({\n  fetchOptions: {\n    proxy: 'http://localhost:8888',\n  },\n});\n```\n\n<img src=\"https://raw.githubusercontent.com/stainless-api/sdk-assets/refs/heads/main/deno.svg\" align=\"top\" width=\"18\" height=\"21\"> **Deno** <sup>[[docs](https://docs.deno.com/api/deno/~/Deno.createHttpClient)]</sup>\n\n```ts\nimport Stainless10 from 'npm:@stainless-api/sdk';\n\nconst httpClient = Deno.createHttpClient({ proxy: { url: 'http://localhost:8888' } });\nconst client = new Stainless10({\n  fetchOptions: {\n    client: httpClient,\n  },\n});\n```\n\n## Frequently Asked Questions\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes that only affect static types, without breaking runtime behavior.\n2. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n3. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-api/stainless-api-typescript/issues) with questions, bugs, or suggestions.\n\n## Requirements\n\nTypeScript >= 4.9 is supported.\n\nThe following runtimes are supported:\n\n- Web browsers (Up-to-date Chrome, Firefox, Safari, Edge, and more)\n- Node.js 20 LTS or later ([non-EOL](https://endoflife.date/nodejs)) versions.\n- Deno v1.28.0 or higher.\n- Bun 1.0 or later.\n- Cloudflare Workers.\n- Vercel Edge Runtime.\n- Jest 28 or greater with the `\"node\"` environment (`\"jsdom\"` is not supported at this time).\n- Nitro v2.6 or greater.\n\nNote that React Native is not supported at this time.\n\nIf you are interested in other runtime environments, please open or upvote an issue on GitHub.\n\n## Contributing\n\nSee [the contributing documentation](./CONTRIBUTING.md).\n",
  },
  {
    language: 'ruby',
    content:
      '# Stainless10 Ruby API library\n\nThe Stainless10 Ruby library provides convenient access to the Stainless10 REST API from any Ruby 3.2.0+ application. It ships with comprehensive types & docstrings in Yard, RBS, and RBI – [see below](https://github.com/stainless-sdks/stainless10-ruby#Sorbet) for usage with Sorbet. The standard library\'s `net/http` is used as the HTTP transport, with connection pooling via the `connection_pool` gem.\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless10 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczEwLnN0bG1jcC5jb20iLCJoZWFkZXJzIjp7Ingtc3RhaW5sZXNzLWFwaS1rZXkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless10.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\n## Documentation\n\nDocumentation for releases of this gem can be found [on RubyDoc](https://gemdocs.org/gems/stainless-v0).\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli).\n\n## Installation\n\nTo use this gem, install via Bundler by adding the following to your application\'s `Gemfile`:\n\n```ruby\ngem "stainless-v0", "~> 0.0.1"\n```\n\n## Usage\n\n```ruby\nrequire "bundler/setup"\nrequire "stainless_v0"\n\nstainless10 = StainlessV0::Client.new(\n  api_key: ENV["STAINLESS_API_KEY"], # This is the default and can be omitted\n  environment: "staging" # defaults to "production"\n)\n\nbuild = stainless10.builds.create(project: "stainless", revision: "main")\n\nputs(build.id)\n```\n\n\n\n### Pagination\n\nList methods in the Stainless10 API are paginated.\n\nThis library provides auto-paginating iterators with each list response, so you do not have to request successive pages manually:\n\n```ruby\npage = stainless10.builds.list(project: "stainless")\n\n# Fetch single item from page.\nbuild = page.data[0]\nputs(build.id)\n\n# Automatically fetches more pages as needed.\npage.auto_paging_each do |build|\n  puts(build.id)\nend\n```\n\nAlternatively, you can use the `#next_page?` and `#next_page` methods for more granular control working with pages.\n\n```ruby\nif page.next_page?\n  new_page = page.next_page\n  puts(new_page.data[0].id)\nend\n```\n\n\n\n### Handling errors\n\nWhen the library is unable to connect to the API, or if the API returns a non-success status code (i.e., 4xx or 5xx response), a subclass of `StainlessV0::Errors::APIError` will be thrown:\n\n```ruby\nbegin\n  build = stainless10.builds.create(project: "stainless", revision: "main")\nrescue StainlessV0::Errors::APIConnectionError => e\n  puts("The server could not be reached")\n  puts(e.cause)  # an underlying Exception, likely raised within `net/http`\nrescue StainlessV0::Errors::RateLimitError => e\n  puts("A 429 status code was received; we should back off a bit.")\nrescue StainlessV0::Errors::APIStatusError => e\n  puts("Another non-200-range status code was received")\n  puts(e.status)\nend\n```\n\nError codes are as follows:\n\n| Cause            | Error Type                 |\n| ---------------- | -------------------------- |\n| HTTP 400         | `BadRequestError`          |\n| HTTP 401         | `AuthenticationError`      |\n| HTTP 403         | `PermissionDeniedError`    |\n| HTTP 404         | `NotFoundError`            |\n| HTTP 409         | `ConflictError`            |\n| HTTP 422         | `UnprocessableEntityError` |\n| HTTP 429         | `RateLimitError`           |\n| HTTP >= 500      | `InternalServerError`      |\n| Other HTTP error | `APIStatusError`           |\n| Timeout          | `APITimeoutError`          |\n| Network error    | `APIConnectionError`       |\n\n### Retries\n\nCertain errors will be automatically retried 2 times by default, with a short exponential backoff.\n\nConnection errors (for example, due to a network connectivity problem), 408 Request Timeout, 409 Conflict, 429 Rate Limit, >=500 Internal errors, and timeouts will all be retried by default.\n\nYou can use the `max_retries` option to configure or disable this:\n\n```ruby\n# Configure the default for all requests:\nstainless10 = StainlessV0::Client.new(\n  max_retries: 0 # default is 2\n)\n\n# Or, configure per-request:\nstainless10.builds.create(project: "stainless", revision: "main", request_options: {max_retries: 5})\n```\n\n### Timeouts\n\nBy default, requests will time out after 60 seconds. You can use the timeout option to configure or disable this:\n\n```ruby\n# Configure the default for all requests:\nstainless10 = StainlessV0::Client.new(\n  timeout: nil # default is 60\n)\n\n# Or, configure per-request:\nstainless10.builds.create(project: "stainless", revision: "main", request_options: {timeout: 5})\n```\n\nOn timeout, `StainlessV0::Errors::APITimeoutError` is raised.\n\nNote that requests that time out are retried by default.\n\n## Advanced concepts\n\n### BaseModel\n\nAll parameter and response objects inherit from `StainlessV0::Internal::Type::BaseModel`, which provides several conveniences, including:\n\n1. All fields, including unknown ones, are accessible with `obj[:prop]` syntax, and can be destructured with `obj => {prop: prop}` or pattern-matching syntax.\n\n2. Structural equivalence for equality; if two API calls return the same values, comparing the responses with == will return true.\n\n3. Both instances and the classes themselves can be pretty-printed.\n\n4. Helpers such as `#to_h`, `#deep_to_h`, `#to_json`, and `#to_yaml`.\n\n### Making custom or undocumented requests\n\n#### Undocumented properties\n\nYou can send undocumented parameters to any endpoint, and read undocumented response properties, like so:\n\nNote: the `extra_` parameters of the same name overrides the documented parameters.\n\n```ruby\nbuild =\n  stainless10.builds.create(\n    project: "stainless",\n    revision: "main",\n    request_options: {\n      extra_query: {my_query_parameter: value},\n      extra_body: {my_body_parameter: value},\n      extra_headers: {"my-header": value}\n    }\n  )\n\nputs(build[:my_undocumented_property])\n```\n\n#### Undocumented request params\n\nIf you want to explicitly send an extra param, you can do so with the `extra_query`, `extra_body`, and `extra_headers` under the `request_options:` parameter when making a request, as seen in the examples above.\n\n#### Undocumented endpoints\n\nTo make requests to undocumented endpoints while retaining the benefit of auth, retries, and so on, you can make requests using `client.request`, like so:\n\n```ruby\nresponse = client.request(\n  method: :post,\n  path: \'/undocumented/endpoint\',\n  query: {"dog": "woof"},\n  headers: {"useful-header": "interesting-value"},\n  body: {"hello": "world"}\n)\n```\n\n### Concurrency & connection pooling\n\nThe `StainlessV0::Client` instances are threadsafe, but are only are fork-safe when there are no in-flight HTTP requests.\n\nEach instance of `StainlessV0::Client` has its own HTTP connection pool with a default size of 99. As such, we recommend instantiating the client once per application in most settings.\n\nWhen all available connections from the pool are checked out, requests wait for a new connection to become available, with queue time counting towards the request timeout.\n\nUnless otherwise specified, other classes in the SDK do not have locks protecting their underlying data structure.\n\n## Sorbet\n\nThis library provides comprehensive [RBI](https://sorbet.org/docs/rbi) definitions, and has no dependency on sorbet-runtime.\n\nYou can provide typesafe request parameters like so:\n\n```ruby\nstainless10.builds.create(project: "stainless", revision: "main")\n```\n\nOr, equivalently:\n\n```ruby\n# Hashes work, but are not typesafe:\nstainless10.builds.create(project: "stainless", revision: "main")\n\n# You can also splat a full Params class:\nparams = StainlessV0::BuildCreateParams.new(project: "stainless", revision: "main")\nstainless10.builds.create(**params)\n```\n\n### Enums\n\nSince this library does not depend on `sorbet-runtime`, it cannot provide [`T::Enum`](https://sorbet.org/docs/tenum) instances. Instead, we provide "tagged symbols" instead, which is always a primitive at runtime:\n\n```ruby\n# :python\nputs(StainlessV0::ProjectGenerateCommitMessageParams::Target::PYTHON)\n\n# Revealed type: `T.all(StainlessV0::ProjectGenerateCommitMessageParams::Target, Symbol)`\nT.reveal_type(StainlessV0::ProjectGenerateCommitMessageParams::Target::PYTHON)\n```\n\nEnum parameters have a "relaxed" type, so you can either pass in enum constants or their literal value:\n\n```ruby\n# Using the enum constants preserves the tagged type information:\nstainless10.projects.generate_commit_message(\n  target: StainlessV0::ProjectGenerateCommitMessageParams::Target::PYTHON,\n  # …\n)\n\n# Literal values are also permissible:\nstainless10.projects.generate_commit_message(\n  target: :python,\n  # …\n)\n```\n\n## Versioning\n\nThis package follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions. As the library is in initial development and has a major version of `0`, APIs may change at any time.\n\nThis package considers improvements to the (non-runtime) `*.rbi` and `*.rbs` type definitions to be non-breaking changes.\n\n## Requirements\n\nRuby 3.2.0 or higher.\n\n## Contributing\n\nSee [the contributing documentation](https://github.com/stainless-sdks/stainless10-ruby/tree/main/CONTRIBUTING.md).\n',
  },
  {
    language: 'java',
    content:
      '# Stainless10 Java API Library\n\n\n[![Maven Central](https://img.shields.io/maven-central/v/com.stainless.api/stainless10-java)](https://central.sonatype.com/artifact/com.stainless.api/stainless10-java/0.0.1)\n[![javadoc](https://javadoc.io/badge2/com.stainless.api/stainless10-java/0.0.1/javadoc.svg)](https://javadoc.io/doc/com.stainless.api/stainless10-java/0.0.1)\n\n\nThe Stainless10 Java SDK provides convenient access to the [Stainless10 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli)   from applications written in Java.\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless10 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczEwLnN0bG1jcC5jb20iLCJoZWFkZXJzIjp7Ingtc3RhaW5sZXNzLWFwaS1rZXkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless10.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.stainless.api/stainless10-java/0.0.1).\n\n## Installation\n\n### Gradle\n\n~~~kotlin\nimplementation("com.stainless.api:stainless10-java:0.0.1")\n~~~\n\n### Maven\n\n~~~xml\n<dependency>\n  <groupId>com.stainless.api</groupId>\n  <artifactId>stainless10-java</artifactId>\n  <version>0.0.1</version>\n</dependency>\n~~~\n\n## Requirements\n\nThis library requires Java 8 or later.\n\n## Usage\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nStainless10Client client = Stainless10OkHttpClient.fromEnv();\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nBuild build = client.builds().create(params);\n```\n\n## Client configuration\n\nConfigure the client using system properties or environment variables:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nStainless10Client client = Stainless10OkHttpClient.fromEnv();\n```\n\nOr manually:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .apiKey("My API Key")\n    .build();\n```\n\nOr using a combination of the two approaches:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    // Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n    // Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\n    .fromEnv()\n    .project("example-project")\n    .build();\n```\n\nSee this table for the available options:\n\n| Setter    | System property               | Environment variable   | Required | Default value                 |\n| --------- | ----------------------------- | ---------------------- | -------- | ----------------------------- |\n| `apiKey`  | `stainless10.stainlessApiKey` | `STAINLESS_API_KEY`    | false    | -                             |\n| `baseUrl` | `stainless10.baseUrl`         | `STAINLESS10_BASE_URL` | true     | `"https://api.stainless.com"` |\n\nSystem properties take precedence over environment variables.\n\n> [!TIP]\n> Don\'t create more than one client in the same application. Each client has a connection pool and\n> thread pools, which are more efficient to share between requests.\n\n### Modifying configuration\n\nTo temporarily use a modified client configuration, while reusing the same connection and thread       pools, call `withOptions()` on any client or service:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\n\nStainless10Client clientWithOptions = client.withOptions(optionsBuilder -> {\n    optionsBuilder.baseUrl("https://example.com");\n    optionsBuilder.maxRetries(42);\n});\n```\n\nThe `withOptions()` method does not affect the original client or service.\n\n## Requests and responses\n\nTo send a request to the Stainless10 API, build an instance of some `Params` class and pass it to the     corresponding client method. When the response is received, it will be deserialized into an instance of     a Java class.\n\nFor example, `client.builds().create(...)` should be called with an instance of `BuildCreateParams`, and it     will return an instance of `Build`.\n\n## Immutability\n\nEach class in the SDK has an associated   [builder](https://blogs.oracle.com/javamagazine/post/exploring-joshua-blochs-builder-design-pattern-in-java)   or factory method for constructing it.\n\nEach class is [immutable](https://docs.oracle.com/javase/tutorial/essential/concurrency/immutable.html)   once constructed. If the class has an associated builder, then it has a `toBuilder()` method, which can   be used to convert it back to a builder for making a modified copy.\n\nBecause each class is immutable, builder modification will _never_ affect already built class instances.\n\n## Asynchronous execution\n\nThe default client is synchronous. To switch to asynchronous execution, call the `async()` method:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\nimport java.util.concurrent.CompletableFuture;\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nStainless10Client client = Stainless10OkHttpClient.fromEnv();\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nCompletableFuture<Build> build = client.async().builds().create(params);\n```\n\nOr create an asynchronous client from the beginning:\n\n```java\nimport com.stainless.api.client.Stainless10ClientAsync;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClientAsync;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\nimport java.util.concurrent.CompletableFuture;\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nStainless10ClientAsync client = Stainless10OkHttpClientAsync.fromEnv();\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nCompletableFuture<Build> build = client.builds().create(params);\n```\n\nThe asynchronous client supports the same options as the synchronous one, except most methods return `CompletableFuture`s.\n\n\n\n\n\n\n\n## Raw responses\n\nThe SDK defines methods that deserialize responses into instances of Java classes.       However, these methods don\'t provide access to the response headers, status code, or the raw response       body.\n\nTo access this data, prefix any HTTP method call on a client or service with `withRawResponse()`:\n\n```java\nimport com.stainless.api.core.http.Headers;\nimport com.stainless.api.core.http.HttpResponseFor;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nHttpResponseFor<Build> build = client.builds().withRawResponse().create(params);\n\nint statusCode = build.statusCode();\nHeaders headers = build.headers();\n```\n\nYou can still deserialize the response into an instance of a Java class if needed:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild parsedBuild = build.parse();\n```\n\n## Error handling\n\nThe SDK throws custom unchecked exception types:\n\n- [`Stainless10ServiceException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/Stainless10ServiceException.kt): Base class for HTTP errors. See this table for which exception       subclass is thrown for each HTTP status code:\n\n  | Status | Exception                                          |\n  | ------ | -------------------------------------------------- |\n  | 400    | [`BadRequestException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/BadRequestException.kt)           |\n  | 401    | [`UnauthorizedException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/UnauthorizedException.kt)         |\n  | 403    | [`PermissionDeniedException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/PermissionDeniedException.kt)     |\n  | 404    | [`NotFoundException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/NotFoundException.kt)             |\n  | 422    | [`UnprocessableEntityException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/UnprocessableEntityException.kt)  |\n  | 429    | [`RateLimitException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/RateLimitException.kt)            |\n  | 5xx    | [`InternalServerException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/InternalServerException.kt)       |\n  | others | [`UnexpectedStatusCodeException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/UnexpectedStatusCodeException.kt) |\n\n- [`Stainless10IoException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/Stainless10IoException.kt): I/O networking errors.\n\n- [`Stainless10RetryableException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/Stainless10RetryableException.kt): Generic error indicating a failure that could be retried by the client.\n\n- [`Stainless10InvalidDataException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/Stainless10InvalidDataException.kt): Failure to interpret successfully parsed data. For example,       when accessing a property that\'s supposed to be required, but the API unexpectedly omitted it from the       response.\n\n- [`Stainless10Exception`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/Stainless10Exception.kt): Base class for all exceptions. Most errors will result in one of the       previously mentioned ones, but completely generic errors may be thrown using the base class.\n\n## Pagination\n\nThe SDK defines methods that return a paginated lists of results. It provides convenient ways to access     the results either one page at a time or item-by-item across all pages.\n\n### Auto-pagination\n\nTo iterate through all results across all pages, use the `autoPager()` method, which automatically     fetches more pages as needed.\n\nWhen using the synchronous client, the method returns an [`Iterable`](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)\n\n```java\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildListPage;\n\nBuildListPage page = client.builds().list();\n\n// Process as an Iterable\nfor (Build build : page.autoPager()) {\n    System.out.println(build);\n}\n\n// Process as a Stream\npage.autoPager()\n    .stream()\n    .limit(50)\n    .forEach(build -> System.out.println(build));\n```\n\nWhen using the asynchronous client, the method returns an [`AsyncStreamResponse`](stainless10-java-core/src/main/kotlin/com/stainless/api/core/http/AsyncStreamResponse.kt):\n\n```java\nimport com.stainless.api.core.http.AsyncStreamResponse;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildListPageAsync;\nimport java.util.Optional;\nimport java.util.concurrent.CompletableFuture;\n\nCompletableFuture<BuildListPageAsync> pageFuture = client.async().builds().list();\n\npageFuture.thenRun(page -> page.autoPager().subscribe(build -> {\n    System.out.println(build);\n}));\n\n// If you need to handle errors or completion of the stream\npageFuture.thenRun(page -> page.autoPager().subscribe(new AsyncStreamResponse.Handler<>() {\n    @Override\n    public void onNext(Build build) {\n        System.out.println(build);\n    }\n\n    @Override\n    public void onComplete(Optional<Throwable> error) {\n        if (error.isPresent()) {\n            System.out.println("Something went wrong!");\n            throw new RuntimeException(error.get());\n        } else {\n            System.out.println("No more!");\n        }\n    }\n}));\n\n// Or use futures\npageFuture.thenRun(page -> page.autoPager()\n    .subscribe(build -> {\n        System.out.println(build);\n    })\n    .onCompleteFuture()\n    .whenComplete((unused, error) -> {\n        if (error != null) {\n            System.out.println("Something went wrong!");\n            throw new RuntimeException(error);\n        } else {\n            System.out.println("No more!");\n        }\n    }));\n```\n\n### Manual pagination\n\nTo access individual page items and manually request the next page, use the `items()`,\n`hasNextPage()`, and `nextPage()` methods:\n\n```java\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildListPage;\n\nBuildListPage page = client.builds().list();\nwhile (true) {\n    for (Build build : page.items()) {\n        System.out.println(build);\n    }\n\n    if (!page.hasNextPage()) {\n        break;\n    }\n\n    page = page.nextPage();\n}\n```\n\n## Logging\n\nThe SDK uses the standard   [OkHttp logging interceptor](https://github.com/square/okhttp/tree/master/okhttp-logging-interceptor).\n\nEnable logging by setting the `STAINLESS10_LOG` environment variable to   `info`:\n\n```sh\nexport STAINLESS10_LOG=info\n```\n\nOr to `debug` for more verbose logging:\n\n```sh\nexport STAINLESS10_LOG=debug\n```\n\n## ProGuard and R8\n\nAlthough the SDK uses reflection, it is still usable with     [ProGuard](https://github.com/Guardsquare/proguard) and     [R8](https://developer.android.com/topic/performance/app-optimization/enable-app-optimization) because     `stainless10-java-core` is published with a     [configuration file](stainless10-java-core/src/main/resources/META-INF/proguard/stainless10-java-core.pro) containing     [keep rules](https://www.guardsquare.com/manual/configuration/usage).\n\nProGuard and R8 should automatically detect and use the published rules, but you can also manually copy     the keep rules if necessary.\n\n\n\n\n\n## Jackson\n\nThe SDK depends on [Jackson](https://github.com/FasterXML/jackson) for JSON     serialization/deserialization. It is compatible with version 2.13.4 or higher,     but depends on version 2.18.2 by default.\n\nThe SDK throws an exception if it detects an incompatible Jackson version at runtime (e.g. if the     default version was overridden in your Maven or Gradle config).\n\nIf the SDK threw an exception, but you\'re _certain_ the version is compatible, then disable the version     check using the `checkJacksonVersionCompatibility` on [`Stainless10OkHttpClient`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClient.kt) or     [`Stainless10OkHttpClientAsync`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClientAsync.kt).\n\n> [!CAUTION]\n> We make no guarantee that the SDK works correctly when the Jackson version check is disabled.\n\nAlso note that there are bugs in older Jackson versions that can affect the SDK. We don\'t work around all     Jackson bugs ([example](https://github.com/FasterXML/jackson-databind/issues/3240)) and expect users to     upgrade Jackson for those instead.\n\n## Network options\n\n### Retries\n\nThe SDK automatically retries 2 times by default, with a short exponential backoff between requests.\n\nOnly the following error types are retried:\n- Connection errors (for example, due to a network connectivity problem)\n- 408 Request Timeout\n- 409 Conflict\n- 429 Rate Limit\n- 5xx Internal\n\nThe API may also explicitly instruct the SDK to retry or not retry a request.\n\nTo set a custom number of retries, configure the client using the `maxRetries` method:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .maxRetries(4)\n    .build();\n```\n\n### Timeouts\n\nRequests time out after 1 minute by default.\n\nTo set a custom timeout, configure the method call using the `timeout` method:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild build = client.builds().create(\n  params, RequestOptions.builder().timeout(Duration.ofSeconds(30)).build()\n);\n```\n\nOr configure the default for all method calls at the client level:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\nimport java.time.Duration;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .timeout(Duration.ofSeconds(30))\n    .build();\n```\n\n### Proxies\n\nTo route requests through a proxy, configure the client using the `proxy` method:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\nimport java.net.InetSocketAddress;\nimport java.net.Proxy;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .proxy(new Proxy(\n      Proxy.Type.HTTP, new InetSocketAddress(\n        "https://example.com", 8080\n      )\n    ))\n    .build();\n```\n\n### Connection pooling\n\nTo customize the underlying OkHttp connection pool, configure the client using the   `maxIdleConnections` and `keepAliveDuration` methods:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\nimport java.time.Duration;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    // If `maxIdleConnections` is set, then `keepAliveDuration` must be set, and vice versa.\n    .maxIdleConnections(10)\n    .keepAliveDuration(Duration.ofMinutes(2))\n    .build();\n```\n\nIf both options are unset, OkHttp\'s default connection pool settings are used.\n\n### HTTPS\n\n> [!NOTE]\n> Most applications should not call these methods, and instead use the system defaults. The defaults include\n> special optimizations that can be lost if the implementations are modified.\n\nTo configure how HTTPS connections are secured, configure the client using the `sslSocketFactory`,   `trustManager`, and `hostnameVerifier` methods:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    // If `sslSocketFactory` is set, then `trustManager` must be set, and vice versa.\n    .sslSocketFactory(yourSSLSocketFactory)\n    .trustManager(yourTrustManager)\n    .hostnameVerifier(yourHostnameVerifier)\n    .build();\n```\n\n### Environments\n\nThe SDK sends requests to the production by default. To send requests to a different     environment, configure the client like so:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .staging()\n    .build();\n```\n\n### Custom HTTP client\n\nThe SDK consists of three artifacts:\n- `stainless10-java-core`\n  - Contains core SDK logic\n  - Does not depend on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless10Client`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10Client.kt), [`Stainless10ClientAsync`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientAsync.kt),             [`Stainless10ClientImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientImpl.kt), and [`Stainless10ClientAsyncImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientAsyncImpl.kt), all of which can             work with any HTTP client\n- `stainless10-java-client-okhttp`\n  - Depends on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless10OkHttpClient`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClient.kt) and [`Stainless10OkHttpClientAsync`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClientAsync.kt), which             provide a way to construct [`Stainless10ClientImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientImpl.kt) and             [`Stainless10ClientAsyncImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientAsyncImpl.kt), respectively, using OkHttp\n- `stainless10-java`\n  - Depends on and exposes the APIs of both `stainless10-java-core` and `stainless10-java-client-okhttp`\n  - Does not have its own logic\n\nThis structure allows replacing the SDK\'s default HTTP client without pulling in unnecessary dependencies.\n\n#### Customized [`OkHttpClient`](https://square.github.io/okhttp/3.x/okhttp/okhttp3/OkHttpClient.html)\n\n> [!TIP]\n> Try the available [network options](#network-options) before replacing the default client.\n\nTo use a customized `OkHttpClient`:\n\n1. Replace your [`stainless10-java` dependency](#installation) with `stainless10-java-core`\n2. Copy `stainless10-java-client-okhttp`\'s [`OkHttpClient`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/OkHttpClient.kt) class into your code and        customize it\n3. Construct [`Stainless10ClientImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientImpl.kt) or [`Stainless10ClientAsyncImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientAsyncImpl.kt), similarly to        [`Stainless10OkHttpClient`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClient.kt) or [`Stainless10OkHttpClientAsync`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClientAsync.kt), using your        customized client\n\n### Completely custom HTTP client\n\nTo use a completely custom HTTP client:\n\n1. Replace your [`stainless10-java` dependency](#installation) with `stainless10-java-core`\n2. Write a class that implements the [`HttpClient`](stainless10-java-core/src/main/kotlin/com/stainless/api/core/http/HttpClient.kt) interface\n3. Construct [`Stainless10ClientImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientImpl.kt) or [`Stainless10ClientAsyncImpl`](stainless10-java-core/src/main/kotlin/com/stainless/api/client/Stainless10ClientAsyncImpl.kt), similarly to        [`Stainless10OkHttpClient`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClient.kt) or [`Stainless10OkHttpClientAsync`](stainless10-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless10OkHttpClientAsync.kt), using your new        client class\n\n## Undocumented API functionality\n\nThe SDK is typed for convenient usage of the documented API. However, it also supports working with undocumented or not yet supported parts of the API.\n\n### Parameters\n\nTo set undocumented parameters, call the `putAdditionalHeader`, `putAdditionalQueryParam`, or       `putAdditionalBodyProperty` methods on any `Params` class:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .putAdditionalHeader("Secret-Header", "42")\n    .putAdditionalQueryParam("secret_query_param", "42")\n    .putAdditionalBodyProperty("secretProperty", JsonValue.from("42"))\n    .build();\n```\n\nThese can be accessed on the built object later using the `_additionalHeaders()`,       `_additionalQueryParams()`, and `_additionalBodyProperties()` methods.\n\nTo set undocumented parameters on _nested_ headers, query params, or body classes, call the         `putAdditionalProperty` method on the nested class:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .targetCommitMessages(BuildCreateParams.TargetCommitMessages.builder()\n        .putAdditionalProperty("secretProperty", JsonValue.from("42"))\n        .build())\n    .build();\n```\n\nThese properties can be accessed on the nested built object later using the         `_additionalProperties()` method.\n\nTo set a documented parameter or property to an undocumented or not yet supported _value_, pass a       [`JsonValue`](stainless10-java-core/src/main/kotlin/com/stainless/api/core/Values.kt) object to its setter:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project(JsonValue.from(42))\n    .revision("main")\n    .build();\n```\n\nThe most straightforward way to create a [`JsonValue`](stainless10-java-core/src/main/kotlin/com/stainless/api/core/Values.kt) is using its       `from(...)` method:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport java.util.List;\nimport java.util.Map;\n\n// Create primitive JSON values\nJsonValue nullValue = JsonValue.from(null);\nJsonValue booleanValue = JsonValue.from(true);\nJsonValue numberValue = JsonValue.from(42);\nJsonValue stringValue = JsonValue.from("Hello World!");\n\n// Create a JSON array value equivalent to `["Hello", "World"]`\nJsonValue arrayValue = JsonValue.from(List.of(\n  "Hello", "World"\n));\n\n// Create a JSON object value equivalent to `{ "a": 1, "b": 2 }`\nJsonValue objectValue = JsonValue.from(Map.of(\n  "a", 1,\n  "b", 2\n));\n\n// Create an arbitrarily nested JSON equivalent to:\n// {\n//   "a": [1, 2],\n//   "b": [3, 4]\n// }\nJsonValue complexValue = JsonValue.from(Map.of(\n  "a", List.of(\n    1, 2\n  ),\n  "b", List.of(\n    3, 4\n  )\n));\n```\n\nNormally a `Builder` class\'s `build` method will throw         [`IllegalStateException`](https://docs.oracle.com/javase/8/docs/api/java/lang/IllegalStateException.html)         if any required parameter or property is unset.\n\nTo forcibly omit a required parameter or property, pass [`JsonMissing`](stainless10-java-core/src/main/kotlin/com/stainless/api/core/Values.kt):\n\n```java\nimport com.stainless.api.core.JsonMissing;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .revision("string")\n    .project(JsonMissing.of())\n    .build();\n```\n\n### Response properties\n\nTo access undocumented response properties, call the `_additionalProperties()` method:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport java.util.Map;\n\nMap<String, JsonValue> additionalProperties = client.builds().create(params)._additionalProperties();\nJsonValue secretPropertyValue = additionalProperties.get("secretProperty");\n\nString result = secretPropertyValue.accept(new JsonValue.Visitor<>() {\n    @Override\n    public String visitNull() {\n        return "It\'s null!";\n    }\n\n    @Override\n    public String visitBoolean(boolean value) {\n        return "It\'s a boolean!";\n    }\n\n    @Override\n    public String visitNumber(Number value) {\n        return "It\'s a number!";\n    }\n\n    // Other methods include `visitMissing`, `visitString`, `visitArray`, and `visitObject`\n    // The default implementation of each unimplemented method delegates to `visitDefault`, which throws by default, but can also be overridden\n});\n```\n\nTo access a property\'s raw JSON value, which may be undocumented, call its `_` prefixed method:\n\n```java\nimport com.stainless.api.core.JsonField;\nimport java.util.Optional;\n\nJsonField<String> project = client.builds().create(params)._project();\n\nif (project.isMissing()) {\n  // The property is absent from the JSON response\n} else if (project.isNull()) {\n  // The property was set to literal null\n} else {\n  // Check if value was provided as a string\n  // Other methods include `asNumber()`, `asBoolean()`, etc.\n  Optional<String> jsonString = project.asString();\n\n  // Try to deserialize into a custom type\n  MyClass myObject = project.asUnknown().orElseThrow().convert(MyClass.class);\n}\n```\n\n### Response validation\n\nIn rare cases, the API may return a response that doesn\'t match the expected type. For example, the SDK     may expect a property to contain a `String`, but the API could return something else.\n\nBy default, the SDK will not throw an exception in this case. It will throw     [`Stainless10InvalidDataException`](stainless10-java-core/src/main/kotlin/com/stainless/api/errors/Stainless10InvalidDataException.kt) only if you directly access the property.\n\nIf you would prefer to check that the response is completely well-typed upfront, then either call     `validate()`:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild build = client.builds().create(params).validate();\n```\n\nOr configure the method call to validate the response using the `responseValidation` method:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild build = client.builds().create(\n  params, RequestOptions.builder().responseValidation(true).build()\n);\n```\n\nOr configure the default for all method calls at the client level:\n\n```java\nimport com.stainless.api.client.Stainless10Client;\nimport com.stainless.api.client.okhttp.Stainless10OkHttpClient;\n\nStainless10Client client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .responseValidation(true)\n    .build();\n```\n\n## FAQ\n\n### Why don\'t you use plain `enum` classes?\n\nJava `enum` classes are not trivially   [forwards compatible](https://www.stainless.com/blog/making-java-enums-forwards-compatible). Using them in   the SDK could cause runtime exceptions if the API is updated to respond with a new enum value.\n\n### Why do you represent fields using `JsonField<T>` instead of just plain `T`?\n\nUsing `JsonField<T>` enables a few features:\n\n- Allowing usage of [undocumented API functionality](#undocumented-api-functionality)\n- Lazily [validating the API response against the expected shape](#response-validation)\n- Representing absent vs explicitly null values\n\n### Why don\'t you use [`data` classes](https://kotlinlang.org/docs/data-classes.html)?\n\nIt is not [backwards compatible to add new fields to a data class](https://kotlinlang.org/docs/api-guidelines-backward-compatibility.html#avoid-using-data-classes-in-your-api)   and we don\'t want to introduce a breaking change every time we add a field to a class.\n\n### Why don\'t you use checked exceptions?\n\nChecked exceptions are widely considered a mistake in the Java programming language. In fact, they were   omitted from Kotlin for this reason.\n\nChecked exceptions:\n\n- Are verbose to handle\n- Encourage error handling at the wrong level of abstraction, where nothing can be done about the error\n- Are tedious to propagate due to the [function coloring problem](https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function)\n- Don\'t play well with lambdas (also due to the function coloring problem)\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n2. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/stainless10-java/issues) with questions, bugs, or suggestions.\n',
  },
  {
    language: 'kotlin',
    content:
      '# Stainless10 Kotlin API Library\n\n\n[![Maven Central](https://img.shields.io/maven-central/v/com.configure_me_stainless_v0.api/stainless10-kotlin)](https://central.sonatype.com/artifact/com.configure_me_stainless_v0.api/stainless10-kotlin/0.0.1)\n[![javadoc](https://javadoc.io/badge2/com.configure_me_stainless_v0.api/stainless10-kotlin/0.0.1/javadoc.svg)](https://javadoc.io/doc/com.configure_me_stainless_v0.api/stainless10-kotlin/0.0.1)\n\n\nThe Stainless10 Kotlin SDK provides convenient access to the [Stainless10 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli)   from applications written in Kotlin.\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless10 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczEwLnN0bG1jcC5jb20iLCJoZWFkZXJzIjp7Ingtc3RhaW5sZXNzLWFwaS1rZXkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless10.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.configure_me_stainless_v0.api/stainless10-kotlin/0.0.1).\n\n## Installation\n\n### Gradle\n\n~~~kotlin\nimplementation("com.CONFIGURE_ME_stainless_v0.api:stainless10-kotlin:0.0.1")\n~~~\n\n### Maven\n\n~~~xml\n<dependency>\n  <groupId>com.CONFIGURE_ME_stainless_v0.api</groupId>\n  <artifactId>stainless10-kotlin</artifactId>\n  <version>0.0.1</version>\n</dependency>\n~~~\n\n## Requirements\n\nThis library requires Java 8 or later.\n\n## Usage\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nval client: Stainless10Client = Stainless10OkHttpClient.fromEnv()\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: Build = client.builds().create(params)\n```\n\n## Client configuration\n\nConfigure the client using system properties or environment variables:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nval client: Stainless10Client = Stainless10OkHttpClient.fromEnv()\n```\n\nOr manually:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .apiKey("My API Key")\n    .build()\n```\n\nOr using a combination of the two approaches:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    // Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n    // Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\n    .fromEnv()\n    .project("example-project")\n    .build()\n```\n\nSee this table for the available options:\n\n| Setter    | System property               | Environment variable   | Required | Default value                 |\n| --------- | ----------------------------- | ---------------------- | -------- | ----------------------------- |\n| `apiKey`  | `stainless10.stainlessApiKey` | `STAINLESS_API_KEY`    | false    | -                             |\n| `baseUrl` | `stainless10.baseUrl`         | `STAINLESS10_BASE_URL` | true     | `"https://api.stainless.com"` |\n\nSystem properties take precedence over environment variables.\n\n> [!TIP]\n> Don\'t create more than one client in the same application. Each client has a connection pool and\n> thread pools, which are more efficient to share between requests.\n\n### Modifying configuration\n\nTo temporarily use a modified client configuration, while reusing the same connection and thread       pools, call `withOptions()` on any client or service:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\n\nval clientWithOptions: Stainless10Client = client.withOptions {\n    it.baseUrl("https://example.com")\n    it.maxRetries(42)\n}\n```\n\nThe `withOptions()` method does not affect the original client or service.\n\n## Requests and responses\n\nTo send a request to the Stainless10 API, build an instance of some `Params` class and pass it to the     corresponding client method. When the response is received, it will be deserialized into an instance of     a Kotlin class.\n\nFor example, `client.builds().create(...)` should be called with an instance of `BuildCreateParams`, and it     will return an instance of `Build`.\n\n## Immutability\n\nEach class in the SDK has an associated   [builder](https://blogs.oracle.com/javamagazine/post/exploring-joshua-blochs-builder-design-pattern-in-java)   or factory method for constructing it.\n\nEach class is [immutable](https://docs.oracle.com/javase/tutorial/essential/concurrency/immutable.html)   once constructed. If the class has an associated builder, then it has a `toBuilder()` method, which can   be used to convert it back to a builder for making a modified copy.\n\nBecause each class is immutable, builder modification will _never_ affect already built class instances.\n\n## Asynchronous execution\n\nThe default client is synchronous. To switch to asynchronous execution, call the `async()` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nval client: Stainless10Client = Stainless10OkHttpClient.fromEnv()\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: Build = client.async().builds().create(params)\n```\n\nOr create an asynchronous client from the beginning:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10ClientAsync\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClientAsync\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\n// Configures using the `stainless10.stainlessApiKey` and `stainless10.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS10_BASE_URL` environment variables\nval client: Stainless10ClientAsync = Stainless10OkHttpClientAsync.fromEnv()\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: Build = client.builds().create(params)\n```\n\nThe asynchronous client supports the same options as the synchronous one, except most methods are [suspending](https://kotlinlang.org/docs/coroutines-guide.html).\n\n\n\n\n\n\n\n## Raw responses\n\nThe SDK defines methods that deserialize responses into instances of Kotlin classes.       However, these methods don\'t provide access to the response headers, status code, or the raw response       body.\n\nTo access this data, prefix any HTTP method call on a client or service with `withRawResponse()`:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.http.Headers\nimport com.configure_me_stainless_v0.api.core.http.HttpResponseFor\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: HttpResponseFor<Build> = client.builds().withRawResponse().create(params)\n\nval statusCode: Int = build.statusCode()\nval headers: Headers = build.headers()\n```\n\nYou can still deserialize the response into an instance of a Kotlin class if needed:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval parsedBuild: Build = build.parse()\n```\n\n## Error handling\n\nThe SDK throws custom unchecked exception types:\n\n- [`Stainless10ServiceException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless10ServiceException.kt): Base class for HTTP errors. See this table for which exception       subclass is thrown for each HTTP status code:\n\n  | Status | Exception                                          |\n  | ------ | -------------------------------------------------- |\n  | 400    | [`BadRequestException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/BadRequestException.kt)           |\n  | 401    | [`UnauthorizedException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/UnauthorizedException.kt)         |\n  | 403    | [`PermissionDeniedException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/PermissionDeniedException.kt)     |\n  | 404    | [`NotFoundException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/NotFoundException.kt)             |\n  | 422    | [`UnprocessableEntityException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/UnprocessableEntityException.kt)  |\n  | 429    | [`RateLimitException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/RateLimitException.kt)            |\n  | 5xx    | [`InternalServerException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/InternalServerException.kt)       |\n  | others | [`UnexpectedStatusCodeException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/UnexpectedStatusCodeException.kt) |\n\n- [`Stainless10IoException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless10IoException.kt): I/O networking errors.\n\n- [`Stainless10RetryableException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless10RetryableException.kt): Generic error indicating a failure that could be retried by the client.\n\n- [`Stainless10InvalidDataException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless10InvalidDataException.kt): Failure to interpret successfully parsed data. For example,       when accessing a property that\'s supposed to be required, but the API unexpectedly omitted it from the       response.\n\n- [`Stainless10Exception`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless10Exception.kt): Base class for all exceptions. Most errors will result in one of the       previously mentioned ones, but completely generic errors may be thrown using the base class.\n\n## Pagination\n\nThe SDK defines methods that return a paginated lists of results. It provides convenient ways to access     the results either one page at a time or item-by-item across all pages.\n\n### Auto-pagination\n\nTo iterate through all results across all pages, use the `autoPager()` method, which automatically     fetches more pages as needed.\n\nWhen using the synchronous client, the method returns a [`Sequence`](https://kotlinlang.org/docs/sequences.html)\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.BuildListPage\n\nval page: BuildListPage = client.builds().list()\npage.autoPager()\n    .take(50)\n    .forEach { build -> println(build) }\n```\n\nWhen using the asynchronous client, the method returns a [`Flow`](https://kotlinlang.org/docs/flow.html):\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.BuildListPageAsync\n\nval page: BuildListPageAsync = client.async().builds().list()\npage.autoPager()\n    .take(50)\n    .forEach { build -> println(build) }\n```\n\n### Manual pagination\n\nTo access individual page items and manually request the next page, use the `items()`,\n`hasNextPage()`, and `nextPage()` methods:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildListPage\n\nval page: BuildListPage = client.builds().list()\nwhile (true) {\n    for (build in page.items()) {\n        println(build)\n    }\n\n    if (!page.hasNextPage()) {\n        break\n    }\n\n    page = page.nextPage()\n}\n```\n\n## Logging\n\nThe SDK uses the standard   [OkHttp logging interceptor](https://github.com/square/okhttp/tree/master/okhttp-logging-interceptor).\n\nEnable logging by setting the `STAINLESS10_LOG` environment variable to   `info`:\n\n```sh\nexport STAINLESS10_LOG=info\n```\n\nOr to `debug` for more verbose logging:\n\n```sh\nexport STAINLESS10_LOG=debug\n```\n\n## ProGuard and R8\n\nAlthough the SDK uses reflection, it is still usable with     [ProGuard](https://github.com/Guardsquare/proguard) and     [R8](https://developer.android.com/topic/performance/app-optimization/enable-app-optimization) because     `stainless10-kotlin-core` is published with a     [configuration file](stainless10-kotlin-core/src/main/resources/META-INF/proguard/stainless10-kotlin-core.pro) containing     [keep rules](https://www.guardsquare.com/manual/configuration/usage).\n\nProGuard and R8 should automatically detect and use the published rules, but you can also manually copy     the keep rules if necessary.\n\n\n\n\n\n## Jackson\n\nThe SDK depends on [Jackson](https://github.com/FasterXML/jackson) for JSON     serialization/deserialization. It is compatible with version 2.13.4 or higher,     but depends on version 2.18.2 by default.\n\nThe SDK throws an exception if it detects an incompatible Jackson version at runtime (e.g. if the     default version was overridden in your Maven or Gradle config).\n\nIf the SDK threw an exception, but you\'re _certain_ the version is compatible, then disable the version     check using the `checkJacksonVersionCompatibility` on [`Stainless10OkHttpClient`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClient.kt) or     [`Stainless10OkHttpClientAsync`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClientAsync.kt).\n\n> [!CAUTION]\n> We make no guarantee that the SDK works correctly when the Jackson version check is disabled.\n\nAlso note that there are bugs in older Jackson versions that can affect the SDK. We don\'t work around all     Jackson bugs ([example](https://github.com/FasterXML/jackson-databind/issues/3240)) and expect users to     upgrade Jackson for those instead.\n\n## Network options\n\n### Retries\n\nThe SDK automatically retries 2 times by default, with a short exponential backoff between requests.\n\nOnly the following error types are retried:\n- Connection errors (for example, due to a network connectivity problem)\n- 408 Request Timeout\n- 409 Conflict\n- 429 Rate Limit\n- 5xx Internal\n\nThe API may also explicitly instruct the SDK to retry or not retry a request.\n\nTo set a custom number of retries, configure the client using the `maxRetries` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .maxRetries(4)\n    .build()\n```\n\n### Timeouts\n\nRequests time out after 1 minute by default.\n\nTo set a custom timeout, configure the method call using the `timeout` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval build: Build = client.builds().create(\n  params, RequestOptions.builder().timeout(Duration.ofSeconds(30)).build()\n)\n```\n\nOr configure the default for all method calls at the client level:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\nimport java.time.Duration\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .timeout(Duration.ofSeconds(30))\n    .build()\n```\n\n### Proxies\n\nTo route requests through a proxy, configure the client using the `proxy` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\nimport java.net.InetSocketAddress\nimport java.net.Proxy\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .proxy(Proxy(\n      Proxy.Type.HTTP, InetSocketAddress(\n        "https://example.com", 8080\n      )\n    ))\n    .build()\n```\n\n### Connection pooling\n\nTo customize the underlying OkHttp connection pool, configure the client using the   `maxIdleConnections` and `keepAliveDuration` methods:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\nimport java.time.Duration\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    // If `maxIdleConnections` is set, then `keepAliveDuration` must be set, and vice versa.\n    .maxIdleConnections(10)\n    .keepAliveDuration(Duration.ofMinutes(2))\n    .build()\n```\n\nIf both options are unset, OkHttp\'s default connection pool settings are used.\n\n### HTTPS\n\n> [!NOTE]\n> Most applications should not call these methods, and instead use the system defaults. The defaults include\n> special optimizations that can be lost if the implementations are modified.\n\nTo configure how HTTPS connections are secured, configure the client using the `sslSocketFactory`,   `trustManager`, and `hostnameVerifier` methods:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    // If `sslSocketFactory` is set, then `trustManager` must be set, and vice versa.\n    .sslSocketFactory(yourSSLSocketFactory)\n    .trustManager(yourTrustManager)\n    .hostnameVerifier(yourHostnameVerifier)\n    .build()\n```\n\n### Environments\n\nThe SDK sends requests to the production by default. To send requests to a different     environment, configure the client like so:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .staging()\n    .build()\n```\n\n### Custom HTTP client\n\nThe SDK consists of three artifacts:\n- `stainless10-kotlin-core`\n  - Contains core SDK logic\n  - Does not depend on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless10Client`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10Client.kt), [`Stainless10ClientAsync`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientAsync.kt),             [`Stainless10ClientImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientImpl.kt), and [`Stainless10ClientAsyncImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientAsyncImpl.kt), all of which can             work with any HTTP client\n- `stainless10-kotlin-client-okhttp`\n  - Depends on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless10OkHttpClient`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClient.kt) and [`Stainless10OkHttpClientAsync`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClientAsync.kt), which             provide a way to construct [`Stainless10ClientImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientImpl.kt) and             [`Stainless10ClientAsyncImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientAsyncImpl.kt), respectively, using OkHttp\n- `stainless10-kotlin`\n  - Depends on and exposes the APIs of both `stainless10-kotlin-core` and `stainless10-kotlin-client-okhttp`\n  - Does not have its own logic\n\nThis structure allows replacing the SDK\'s default HTTP client without pulling in unnecessary dependencies.\n\n#### Customized [`OkHttpClient`](https://square.github.io/okhttp/3.x/okhttp/okhttp3/OkHttpClient.html)\n\n> [!TIP]\n> Try the available [network options](#network-options) before replacing the default client.\n\nTo use a customized `OkHttpClient`:\n\n1. Replace your [`stainless10-kotlin` dependency](#installation) with `stainless10-kotlin-core`\n2. Copy `stainless10-kotlin-client-okhttp`\'s [`OkHttpClient`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/OkHttpClient.kt) class into your code and        customize it\n3. Construct [`Stainless10ClientImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientImpl.kt) or [`Stainless10ClientAsyncImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientAsyncImpl.kt), similarly to        [`Stainless10OkHttpClient`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClient.kt) or [`Stainless10OkHttpClientAsync`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClientAsync.kt), using your        customized client\n\n### Completely custom HTTP client\n\nTo use a completely custom HTTP client:\n\n1. Replace your [`stainless10-kotlin` dependency](#installation) with `stainless10-kotlin-core`\n2. Write a class that implements the [`HttpClient`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/http/HttpClient.kt) interface\n3. Construct [`Stainless10ClientImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientImpl.kt) or [`Stainless10ClientAsyncImpl`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless10ClientAsyncImpl.kt), similarly to        [`Stainless10OkHttpClient`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClient.kt) or [`Stainless10OkHttpClientAsync`](stainless10-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless10OkHttpClientAsync.kt), using your new        client class\n\n## Undocumented API functionality\n\nThe SDK is typed for convenient usage of the documented API. However, it also supports working with undocumented or not yet supported parts of the API.\n\n### Parameters\n\nTo set undocumented parameters, call the `putAdditionalHeader`, `putAdditionalQueryParam`, or       `putAdditionalBodyProperty` methods on any `Params` class:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .putAdditionalHeader("Secret-Header", "42")\n    .putAdditionalQueryParam("secret_query_param", "42")\n    .putAdditionalBodyProperty("secretProperty", JsonValue.from("42"))\n    .build()\n```\n\nThese can be accessed on the built object later using the `_additionalHeaders()`,       `_additionalQueryParams()`, and `_additionalBodyProperties()` methods.\n\nTo set undocumented parameters on _nested_ headers, query params, or body classes, call the         `putAdditionalProperty` method on the nested class:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .targetCommitMessages(BuildCreateParams.TargetCommitMessages.builder()\n        .putAdditionalProperty("secretProperty", JsonValue.from("42"))\n        .build())\n    .build()\n```\n\nThese properties can be accessed on the nested built object later using the         `_additionalProperties()` method.\n\nTo set a documented parameter or property to an undocumented or not yet supported _value_, pass a       [`JsonValue`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/Values.kt) object to its setter:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project(JsonValue.from(42))\n    .revision("main")\n    .build()\n```\n\nThe most straightforward way to create a [`JsonValue`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/Values.kt) is using its       `from(...)` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\n\n// Create primitive JSON values\nval nullValue: JsonValue = JsonValue.from(null)\nval booleanValue: JsonValue = JsonValue.from(true)\nval numberValue: JsonValue = JsonValue.from(42)\nval stringValue: JsonValue = JsonValue.from("Hello World!")\n\n// Create a JSON array value equivalent to `["Hello", "World"]`\nval arrayValue: JsonValue = JsonValue.from(listOf(\n  "Hello", "World"\n))\n\n// Create a JSON object value equivalent to `{ "a": 1, "b": 2 }`\nval objectValue: JsonValue = JsonValue.from(mapOf(\n  "a" to 1, "b" to 2\n))\n\n// Create an arbitrarily nested JSON equivalent to:\n// {\n//   "a": [1, 2],\n//   "b": [3, 4]\n// }\nval complexValue: JsonValue = JsonValue.from(mapOf(\n  "a" to listOf(\n    1, 2\n  ), "b" to listOf(\n    3, 4\n  )\n))\n```\n\nNormally a `Builder` class\'s `build` method will throw         [`IllegalStateException`](https://docs.oracle.com/javase/8/docs/api/java/lang/IllegalStateException.html)         if any required parameter or property is unset.\n\nTo forcibly omit a required parameter or property, pass [`JsonMissing`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/Values.kt):\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonMissing\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .revision("string")\n    .project(JsonMissing.of())\n    .build()\n```\n\n### Response properties\n\nTo access undocumented response properties, call the `_additionalProperties()` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonBoolean\nimport com.configure_me_stainless_v0.api.core.JsonNull\nimport com.configure_me_stainless_v0.api.core.JsonNumber\nimport com.configure_me_stainless_v0.api.core.JsonValue\n\nval additionalProperties: Map<String, JsonValue> = client.builds().create(params)._additionalProperties()\nval secretPropertyValue: JsonValue = additionalProperties.get("secretProperty")\n\nval result = when (secretPropertyValue) {\n    is JsonNull -> "It\'s null!"\n    is JsonBoolean -> "It\'s a boolean!"\n    is JsonNumber -> "It\'s a number!"\n    // Other types include `JsonMissing`, `JsonString`, `JsonArray`, and `JsonObject`\n    else -> "It\'s something else!"\n}\n```\n\nTo access a property\'s raw JSON value, which may be undocumented, call its `_` prefixed method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonField\n\nval project: JsonField<String> = client.builds().create(params)._project()\n\nif (project.isMissing()) {\n  // The property is absent from the JSON response\n} else if (project.isNull()) {\n  // The property was set to literal null\n} else {\n  // Check if value was provided as a string\n  // Other methods include `asNumber()`, `asBoolean()`, etc.\n  val jsonString: String? = project.asString();\n\n  // Try to deserialize into a custom type\n  val myObject: MyClass = project.asUnknown()!!.convert(MyClass::class.java)\n}\n```\n\n### Response validation\n\nIn rare cases, the API may return a response that doesn\'t match the expected type. For example, the SDK     may expect a property to contain a `String`, but the API could return something else.\n\nBy default, the SDK will not throw an exception in this case. It will throw     [`Stainless10InvalidDataException`](stainless10-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless10InvalidDataException.kt) only if you directly access the property.\n\nIf you would prefer to check that the response is completely well-typed upfront, then either call     `validate()`:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval build: Build = client.builds().create(params).validate()\n```\n\nOr configure the method call to validate the response using the `responseValidation` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval build: Build = client.builds().create(\n  params, RequestOptions.builder().responseValidation(true).build()\n)\n```\n\nOr configure the default for all method calls at the client level:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless10Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless10OkHttpClient\n\nval client: Stainless10Client = Stainless10OkHttpClient.builder()\n    .fromEnv()\n    .responseValidation(true)\n    .build()\n```\n\n## FAQ\n\n### Why don\'t you use plain `enum` classes?\n\nKotlin `enum` classes are not trivially   [forwards compatible](https://www.stainless.com/blog/making-java-enums-forwards-compatible). Using them in   the SDK could cause runtime exceptions if the API is updated to respond with a new enum value.\n\n### Why do you represent fields using `JsonField<T>` instead of just plain `T`?\n\nUsing `JsonField<T>` enables a few features:\n\n- Allowing usage of [undocumented API functionality](#undocumented-api-functionality)\n- Lazily [validating the API response against the expected shape](#response-validation)\n- Representing absent vs explicitly null values\n\n### Why don\'t you use [`data` classes](https://kotlinlang.org/docs/data-classes.html)?\n\nIt is not [backwards compatible to add new fields to a data class](https://kotlinlang.org/docs/api-guidelines-backward-compatibility.html#avoid-using-data-classes-in-your-api)   and we don\'t want to introduce a breaking change every time we add a field to a class.\n\n### Why don\'t you use checked exceptions?\n\nChecked exceptions are widely considered a mistake in the Java programming language. In fact, they were   omitted from Kotlin for this reason.\n\nChecked exceptions:\n\n- Are verbose to handle\n- Encourage error handling at the wrong level of abstraction, where nothing can be done about the error\n- Are tedious to propagate due to the [function coloring problem](https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function)\n- Don\'t play well with lambdas (also due to the function coloring problem)\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n2. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/stainless10-kotlin/issues) with questions, bugs, or suggestions.\n',
  },
  {
    language: 'csharp',
    content:
      '# Stainless10 C# API Library\n\nThe Stainless10 C# SDK provides convenient access to the [Stainless10 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli) from applications written in   C#.\n\n## Installation\n\n```bash\ngit clone git@github.com:stainless-sdks/stainless10-csharp.git\ndotnet add reference stainless10-csharp/src/StainlessV0\n```\n\n## Requirements\n\nThis library requires .NET Standard 2.0 or later.\n\n## Usage\n\nSee the [`examples`](examples) directory for complete and runnable examples.\n\n```csharp\nStainless10Client client = new();\n\nBuildCreateParams parameters = new()\n{\n    Project = "stainless",\n    Revision = "main",\n};\n\nvar build = await client.Builds.Create(parameters);\n\nConsole.WriteLine(build);\n```',
  },
  {
    language: 'cli',
    content:
      "# Stainless10 CLI\n\nThe official CLI for the [Stainless10 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli).\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n<!-- x-release-please-start-version -->\n\n## Installation\n\n### Installing with Homebrew\n\n~~~sh\nbrew install stainless-api/tap/stl\n~~~\n\n### Installing with Go\n\nTo test or install the CLI locally, you need [Go](https://go.dev/doc/install) version 1.22 or later installed.\n\n~~~sh\ngo install 'github.com/stainless-api/stainless-api-cli/cmd/stl@latest'\n~~~\n\nOnce you have run `go install`, the binary is placed in your Go bin directory:\n\n- **Default location**: `$HOME/go/bin` (or `$GOPATH/bin` if GOPATH is set)\n- **Check your path**: Run `go env GOPATH` to see the base directory\n\nIf commands aren't found after installation, add the Go bin directory to your PATH:\n\n~~~sh\n# Add to your shell profile (.zshrc, .bashrc, etc.)\nexport PATH=\"$PATH:$(go env GOPATH)/bin\"\n~~~\n\n<!-- x-release-please-end -->\n\n### Running Locally\n\nAfter cloning the git repository for this project, you can use the\n`scripts/run` script to run the tool locally:\n\n~~~sh\n./scripts/run args...\n~~~\n\n## Usage\n\nThe CLI follows a resource-based command structure:\n\n~~~sh\nstl [resource] <command> [flags...]\n~~~\n\n~~~sh\nstl builds create \\\n  --api-key 'My API Key' \\\n  --project stainless \\\n  --revision main\n~~~\n\nFor details about specific commands, use the `--help` flag.\n\n### Environment variables\n\n| Environment variable | Required | Default value |\n| -------------------- | -------- | ------------- |\n| `STAINLESS_API_KEY`  | no       | `null`        |\n\n### Global flags\n\n- `--api-key` (can also be set with `STAINLESS_API_KEY` env var)\n- `--project`\n- `--help` - Show command line usage\n- `--debug` - Enable debug logging (includes HTTP request/response details)\n- `--version`, `-v` - Show the CLI version\n- `--base-url` - Use a custom API backend URL\n- `--format` - Change the output format (`auto`, `explore`, `json`, `jsonl`, `pretty`, `raw`, `yaml`)\n- `--format-error` - Change the output format for errors (`auto`, `explore`, `json`, `jsonl`, `pretty`, `raw`, `yaml`)\n- `--transform` - Transform the data output using [GJSON syntax](https://github.com/tidwall/gjson/blob/master/SYNTAX.md)\n- `--transform-error` - Transform the error output using [GJSON syntax](https://github.com/tidwall/gjson/blob/master/SYNTAX.md)\n\n### Passing files as arguments\n\nTo pass files to your API, you can use the `@myfile.ext` syntax:\n\n~~~bash\nstl <command> --arg @abe.jpg\n~~~\n\nFiles can also be passed inside JSON or YAML blobs:\n\n~~~bash\nstl <command> --arg '{image: \"@abe.jpg\"}'\n# Equivalent:\nstl <command> <<YAML\narg:\n  image: \"@abe.jpg\"\nYAML\n~~~\n\nIf you need to pass a string literal that begins with an `@` sign, you can\nescape the `@` sign to avoid accidentally passing a file.\n\n~~~bash\nstl <command> --username '\\@abe'\n~~~\n\n#### Explicit encoding\n\nFor JSON endpoints, the CLI tool does filetype sniffing to determine whether the\nfile contents should be sent as a string literal (for plain text files) or as a\nbase64-encoded string literal (for binary files). If you need to explicitly send\nthe file as either plain text or base64-encoded data, you can use\n`@file://myfile.txt` (for string encoding) or `@data://myfile.dat` (for\nbase64-encoding). Note that absolute paths will begin with `@file://` or\n`@data://`, followed by a third `/` (for example, `@file:///tmp/file.txt`).\n\n~~~bash\nstl <command> --arg @data://file.txt\n~~~\n",
  },
  {
    language: 'php',
    content:
      '# Stainless10 PHP API Library\n\nThe Stainless10 PHP library provides convenient access to the Stainless10 REST API from any PHP 8.1.0+ application.\n\n## Installation\n\nTo use this package, install via Composer by adding the following to your application\'s `composer.json`:\n\n```json\n{\n  "repositories": [\n    {\n      "type": "vcs",\n      "url": "git@github.com:stainless-sdks/stainless10-php.git"\n    }\n  ],\n  "require": {\n    "org-placeholder/stainless-v0": "dev-main"\n  }\n}\n```\n\n## Usage\n\n```php\n<?php\n\n$client = new Client(\n  apiKey: getenv(\'STAINLESS_API_KEY\') ?: \'My API Key\', environment: \'staging\'\n);\n\n$build = $client->builds->create(project: \'stainless\', revision: \'main\');\n\nvar_dump($build->id);\n```',
  },
];
