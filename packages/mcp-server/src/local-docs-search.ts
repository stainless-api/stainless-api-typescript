  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.update',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject = stainless4.projects.update(project: "project")\n\nputs(project)',
      },
      typescript: {
        method: 'client.projects.update',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.create',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject = stainless4.projects.create(\n  display_name: "display_name",\n  org: "org",\n  revision: {foo: {content: "content"}},\n  slug: "slug",\n  targets: [:node]\n)\n\nputs(project)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.generate_commit_message',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nresponse = stainless4.projects.generate_commit_message(\n  project: "project",\n  target: :python,\n  base_ref: "base_ref",\n  head_ref: "head_ref"\n)\n\nputs(response)',
      },
      typescript: {
        method: 'client.projects.generateCommitMessage',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.create',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless4.projects.branches.create(project: "project", branch: "branch", branch_from: "branch_from")\n\nputs(project_branch)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.retrieve',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless4.projects.branches.retrieve("branch", project: "project")\n\nputs(project_branch)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.list',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\npage = stainless4.projects.branches.list(project: "project")\n\nputs(page)',
      },
      typescript: {
        method: 'client.projects.branches.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.delete',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nbranch = stainless4.projects.branches.delete("branch", project: "project")\n\nputs(branch)',
      },
      typescript: {
        method: 'client.projects.branches.delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.rebase',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless4.projects.branches.rebase("branch", project: "project")\n\nputs(project_branch)',
      },
      typescript: {
        method: 'client.projects.branches.rebase',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.branches.reset',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nproject_branch = stainless4.projects.branches.reset("branch", project: "project")\n\nputs(project_branch)',
      },
      typescript: {
        method: 'client.projects.branches.reset',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.configs.retrieve',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nconfig = stainless4.projects.configs.retrieve(project: "project")\n\nputs(config)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'projects.configs.guess',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nresponse = stainless4.projects.configs.guess(project: "project", spec: "spec")\n\nputs(response)',
      },
      typescript: {
        method: 'client.projects.configs.guess',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.list',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\npage = stainless4.builds.list(project: "project")\n\nputs(page)',
      },
      typescript: {
        method: 'client.builds.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.create',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nbuild = stainless4.builds.create(project: "project", revision: "string")\n\nputs(build)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.retrieve',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nbuild = stainless4.builds.retrieve("buildId")\n\nputs(build)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.compare',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\nresponse = stainless4.builds.compare(\n  base: {branch: "branch", revision: "string"},\n  head: {branch: "branch", revision: "string"},\n  project: "project"\n)\n\nputs(response)',
      },
      typescript: {
        method: 'client.builds.compare',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.diagnostics.list',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\npage = stainless4.builds.diagnostics.list("buildId")\n\nputs(page)',
      },
      typescript: {
        method: 'client.builds.diagnostics.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'builds.target_outputs.retrieve',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\ntarget_output = stainless4.builds.target_outputs.retrieve(build_id: "build_id", target: :node, type: :source)\n\nputs(target_output)',
      },
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'orgs.retrieve',
        example:
          'require "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: "My API Key",\n  environment: "staging" # defaults to "production"\n)\n\norg = stainless4.orgs.retrieve("org")\n\nputs(org)',
      },
      typescript: {
...
const EMBEDDED_READMES: { language: string; content: string }[] = [
  ...
  },
  {
    language: 'ruby',
    content:
      '# Stainless4 Ruby API library\n\nThe Stainless4 Ruby library provides convenient access to the Stainless4 REST API from any Ruby 3.2.0+ application. It ships with comprehensive types & docstrings in Yard, RBS, and RBI – [see below](https://github.com/stainless-sdks/stainless4-ruby#Sorbet) for usage with Sorbet. The standard library\'s `net/http` is used as the HTTP transport, with connection pooling via the `connection_pool` gem.\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless4 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczQuc3RsbWNwLmNvbSIsImhlYWRlcnMiOnsieC1zdGFpbmxlc3MtYXBpLWtleSI6Ik15IEFQSSBLZXkifX0)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless4.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\n## Documentation\n\nDocumentation for releases of this gem can be found [on RubyDoc](https://gemdocs.org/gems/stainless-v0).\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli).\n\n## Installation\n\nTo use this gem, install via Bundler by adding the following to your application\'s `Gemfile`:\n\n```ruby\ngem "stainless-v0", "~> 0.0.1"\n```\n\n## Usage\n\n```ruby\nrequire "bundler/setup"\nrequire "stainless_v0"\n\nstainless4 = StainlessV0::Client.new(\n  api_key: ENV["STAINLESS_API_KEY"], # This is the default and can be omitted\n  environment: "staging" # defaults to "production"\n)\n\nbuild = stainless4.builds.create(project: "stainless", revision: "main")\n\nputs(build.id)\n```\n\n\n\n### Pagination\n\nList methods in the Stainless4 API are paginated.\n\nThis library provides auto-paginating iterators with each list response, so you do not have to request successive pages manually:\n\n```ruby\npage = stainless4.builds.list(project: "stainless")\n\n# Fetch single item from page.\nbuild = page.data[0]\nputs(build.id)\n\n# Automatically fetches more pages as needed.\npage.auto_paging_each do |build|\n  puts(build.id)\nend\n```\n\nAlternatively, you can use the `#next_page?` and `#next_page` methods for more granular control working with pages.\n\n```ruby\nif page.next_page?\n  new_page = page.next_page\n  puts(new_page.data[0].id)\nend\n```\n\n\n\n### Handling errors\n\nWhen the library is unable to connect to the API, or if the API returns a non-success status code (i.e., 4xx or 5xx response), a subclass of `StainlessV0::Errors::APIError` will be thrown:\n\n```ruby\nbegin\n  build = stainless4.builds.create(project: "stainless", revision: "main")\nrescue StainlessV0::Errors::APIConnectionError => e\n  puts("The server could not be reached")\n  puts(e.cause)  # an underlying Exception, likely raised within `net/http`\nrescue StainlessV0::Errors::RateLimitError => e\n  puts("A 429 status code was received; we should back off a bit.")\nrescue StainlessV0::Errors::APIStatusError => e\n  puts("Another non-200-range status code was received")\n  puts(e.status)\nend\n```\n\nError codes are as follows:\n\n| Cause            | Error Type                 |\n| ---------------- | -------------------------- |\n| HTTP 400         | `BadRequestError`          |\n| HTTP 401         | `AuthenticationError`      |\n| HTTP 403         | `PermissionDeniedError`    |\n| HTTP 404         | `NotFoundError`            |\n| HTTP 409         | `ConflictError`            |\n| HTTP 422         | `UnprocessableEntityError` |\n| HTTP 429         | `RateLimitError`           |\n| HTTP >= 500      | `InternalServerError`      |\n| Other HTTP error | `APIStatusError`           |\n| Timeout          | `APITimeoutError`          |\n| Network error    | `APIConnectionError`       |\n\n### Retries\n\nCertain errors will be automatically retried 2 times by default, with a short exponential backoff.\n\nConnection errors (for example, due to a network connectivity problem), 408 Request Timeout, 409 Conflict, 429 Rate Limit, >=500 Internal errors, and timeouts will all be retried by default.\n\nYou can use the `max_retries` option to configure or disable this:\n\n```ruby\n# Configure the default for all requests:\nstainless4 = StainlessV0::Client.new(\n  max_retries: 0 # default is 2\n)\n\n# Or, configure per-request:\nstainless4.builds.create(project: "stainless", revision: "main", request_options: {max_retries: 5})\n```\n\n### Timeouts\n\nBy default, requests will time out after 60 seconds. You can use the timeout option to configure or disable this:\n\n```ruby\n# Configure the default for all requests:\nstainless4 = StainlessV0::Client.new(\n  timeout: nil # default is 60\n)\n\n# Or, configure per-request:\nstainless4.builds.create(project: "stainless", revision: "main", request_options: {timeout: 5})\n```\n\nOn timeout, `StainlessV0::Errors::APITimeoutError` is raised.\n\nNote that requests that time out are retried by default.\n\n## Advanced concepts\n\n### BaseModel\n\nAll parameter and response objects inherit from `StainlessV0::Internal::Type::BaseModel`, which provides several conveniences, including:\n\n1. All fields, including unknown ones, are accessible with `obj[:prop]` syntax, and can be destructured with `obj => {prop: prop}` or pattern-matching syntax.\n\n2. Structural equivalence for equality; if two API calls return the same values, comparing the responses with == will return true.\n\n3. Both instances and the classes themselves can be pretty-printed.\n\n4. Helpers such as `#to_h`, `#deep_to_h`, `#to_json`, and `#to_yaml`.\n\n### Making custom or undocumented requests\n\n#### Undocumented properties\n\nYou can send undocumented parameters to any endpoint, and read undocumented response properties, like so:\n\nNote: the `extra_` parameters of the same name overrides the documented parameters.\n\n```ruby\nbuild =\n  stainless4.builds.create(\n    project: "stainless",\n    revision: "main",\n    request_options: {\n      extra_query: {my_query_parameter: value},\n      extra_body: {my_body_parameter: value},\n      extra_headers: {"my-header": value}\n    }\n  )\n\nputs(build[:my_undocumented_property])\n```\n\n#### Undocumented request params\n\nIf you want to explicitly send an extra param, you can do so with the `extra_query`, `extra_body`, and `extra_headers` under the `request_options:` parameter when making a request, as seen in the examples above.\n\n#### Undocumented endpoints\n\nTo make requests to undocumented endpoints while retaining the benefit of auth, retries, and so on, you can make requests using `client.request`, like so:\n\n```ruby\nresponse = client.request(\n  method: :post,\n  path: \'/undocumented/endpoint\',\n  query: {"dog": "woof"},\n  headers: {"useful-header": "interesting-value"},\n  body: {"hello": "world"}\n)\n```\n\n### Concurrency & connection pooling\n\nThe `StainlessV0::Client` instances are threadsafe, but are only are fork-safe when there are no in-flight HTTP requests.\n\nEach instance of `StainlessV0::Client` has its own HTTP connection pool with a default size of 99. As such, we recommend instantiating the client once per application in most settings.\n\nWhen all available connections from the pool are checked out, requests wait for a new connection to become available, with queue time counting towards the request timeout.\n\nUnless otherwise specified, other classes in the SDK do not have locks protecting their underlying data structure.\n\n## Sorbet\n\nThis library provides comprehensive [RBI](https://sorbet.org/docs/rbi) definitions, and has no dependency on sorbet-runtime.\n\nYou can provide typesafe request parameters like so:\n\n```ruby\nstainless4.builds.create(project: "stainless", revision: "main")\n```\n\nOr, equivalently:\n\n```ruby\n# Hashes work, but are not typesafe:\nstainless4.builds.create(project: "stainless", revision: "main")\n\n# You can also splat a full Params class:\nparams = StainlessV0::BuildCreateParams.new(project: "stainless", revision: "main")\nstainless4.builds.create(**params)\n```\n\n### Enums\n\nSince this library does not depend on `sorbet-runtime`, it cannot provide [`T::Enum`](https://sorbet.org/docs/tenum) instances. Instead, we provide "tagged symbols" instead, which is always a primitive at runtime:\n\n```ruby\n# :python\nputs(StainlessV0::ProjectGenerateCommitMessageParams::Target::PYTHON)\n\n# Revealed type: `T.all(StainlessV0::ProjectGenerateCommitMessageParams::Target, Symbol)`\nT.reveal_type(StainlessV0::ProjectGenerateCommitMessageParams::Target::PYTHON)\n```\n\nEnum parameters have a "relaxed" type, so you can either pass in enum constants or their literal value:\n\n```ruby\n# Using the enum constants preserves the tagged type information:\nstainless4.projects.generate_commit_message(\n  target: StainlessV0::ProjectGenerateCommitMessageParams::Target::PYTHON,\n  # …\n)\n\n# Literal values are also permissible:\nstainless4.projects.generate_commit_message(\n  target: :python,\n  # …\n)\n```\n\n## Versioning\n\nThis package follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions. As the library is in initial development and has a major version of `0`, APIs may change at any time.\n\nThis package considers improvements to the (non-runtime) `*.rbi` and `*.rbs` type definitions to be non-breaking changes.\n\n## Requirements\n\nRuby 3.2.0 or higher.\n\n## Contributing\n\nSee [the contributing documentation](https://github.com/stainless-sdks/stainless4-ruby/tree/main/CONTRIBUTING.md).\n',
  },
  {
    language: 'java',
    content:
      '# Stainless4 Java API Library\n\n\n[![Maven Central](https://img.shields.io/maven-central/v/com.stainless.api/stainless4-java)](https://central.sonatype.com/artifact/com.stainless.api/stainless4-java/0.0.1)\n[![javadoc](https://javadoc.io/badge2/com.stainless.api/stainless4-java/0.0.1/javadoc.svg)](https://javadoc.io/doc/com.stainless.api/stainless4-java/0.0.1)\n\n\nThe Stainless4 Java SDK provides convenient access to the [Stainless4 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli)   from applications written in Java.\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless4 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczQuc3RsbWNwLmNvbSIsImhlYWRlcnMiOnsieC1zdGFpbmxlc3MtYXBpLWtleSI6Ik15IEFQSSBLZXkifX0)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless4.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.stainless.api/stainless4-java/0.0.1).\n\n## Installation\n\n### Gradle\n\n~~~kotlin\nimplementation("com.stainless.api:stainless4-java:0.0.1")\n~~~\n\n### Maven\n\n~~~xml\n<dependency>\n  <groupId>com.stainless.api</groupId>\n  <artifactId>stainless4-java</artifactId>\n  <version>0.0.1</version>\n</dependency>\n~~~\n\n## Requirements\n\nThis library requires Java 8 or later.\n\n## Usage\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nStainless4Client client = Stainless4OkHttpClient.fromEnv();\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nBuild build = client.builds().create(params);\n```\n\n## Client configuration\n\nConfigure the client using system properties or environment variables:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nStainless4Client client = Stainless4OkHttpClient.fromEnv();\n```\n\nOr manually:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .apiKey("My API Key")\n    .build();\n```\n\nOr using a combination of the two approaches:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    // Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n    // Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\n    .fromEnv()\n    .project("example-project")\n    .build();\n```\n\nSee this table for the available options:\n\n| Setter    | System property              | Environment variable  | Required | Default value                 |\n| --------- | ---------------------------- | --------------------- | -------- | ----------------------------- |\n| `apiKey`  | `stainless4.stainlessApiKey` | `STAINLESS_API_KEY`   | false    | -                             |\n| `baseUrl` | `stainless4.baseUrl`         | `STAINLESS4_BASE_URL` | true     | `"https://api.stainless.com"` |\n\nSystem properties take precedence over environment variables.\n\n> [!TIP]\n> Don\'t create more than one client in the same application. Each client has a connection pool and\n> thread pools, which are more efficient to share between requests.\n\n### Modifying configuration\n\nTo temporarily use a modified client configuration, while reusing the same connection and thread       pools, call `withOptions()` on any client or service:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\n\nStainless4Client clientWithOptions = client.withOptions(optionsBuilder -> {\n    optionsBuilder.baseUrl("https://example.com");\n    optionsBuilder.maxRetries(42);\n});\n```\n\nThe `withOptions()` method does not affect the original client or service.\n\n## Requests and responses\n\nTo send a request to the Stainless4 API, build an instance of some `Params` class and pass it to the     corresponding client method. When the response is received, it will be deserialized into an instance of     a Java class.\n\nFor example, `client.builds().create(...)` should be called with an instance of `BuildCreateParams`, and it     will return an instance of `Build`.\n\n## Immutability\n\nEach class in the SDK has an associated   [builder](https://blogs.oracle.com/javamagazine/post/exploring-joshua-blochs-builder-design-pattern-in-java)   or factory method for constructing it.\n\nEach class is [immutable](https://docs.oracle.com/javase/tutorial/essential/concurrency/immutable.html)   once constructed. If the class has an associated builder, then it has a `toBuilder()` method, which can   be used to convert it back to a builder for making a modified copy.\n\nBecause each class is immutable, builder modification will _never_ affect already built class instances.\n\n## Asynchronous execution\n\nThe default client is synchronous. To switch to asynchronous execution, call the `async()` method:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\nimport java.util.concurrent.CompletableFuture;\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nStainless4Client client = Stainless4OkHttpClient.fromEnv();\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nCompletableFuture<Build> build = client.async().builds().create(params);\n```\n\nOr create an asynchronous client from the beginning:\n\n```java\nimport com.stainless.api.client.Stainless4ClientAsync;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClientAsync;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\nimport java.util.concurrent.CompletableFuture;\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nStainless4ClientAsync client = Stainless4OkHttpClientAsync.fromEnv();\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nCompletableFuture<Build> build = client.builds().create(params);\n```\n\nThe asynchronous client supports the same options as the synchronous one, except most methods return `CompletableFuture`s.\n\n\n\n\n\n\n\n## Raw responses\n\nThe SDK defines methods that deserialize responses into instances of Java classes.       However, these methods don\'t provide access to the response headers, status code, or the raw response       body.\n\nTo access this data, prefix any HTTP method call on a client or service with `withRawResponse()`:\n\n```java\nimport com.stainless.api.core.http.Headers;\nimport com.stainless.api.core.http.HttpResponseFor;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build();\nHttpResponseFor<Build> build = client.builds().withRawResponse().create(params);\n\nint statusCode = build.statusCode();\nHeaders headers = build.headers();\n```\n\nYou can still deserialize the response into an instance of a Java class if needed:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild parsedBuild = build.parse();\n```\n\n## Error handling\n\nThe SDK throws custom unchecked exception types:\n\n- [`Stainless4ServiceException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/Stainless4ServiceException.kt): Base class for HTTP errors. See this table for which exception       subclass is thrown for each HTTP status code:\n\n  | Status | Exception                                          |\n  | ------ | -------------------------------------------------- |\n  | 400    | [`BadRequestException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/BadRequestException.kt)           |\n  | 401    | [`UnauthorizedException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/UnauthorizedException.kt)         |\n  | 403    | [`PermissionDeniedException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/PermissionDeniedException.kt)     |\n  | 404    | [`NotFoundException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/NotFoundException.kt)             |\n  | 422    | [`UnprocessableEntityException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/UnprocessableEntityException.kt)  |\n  | 429    | [`RateLimitException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/RateLimitException.kt)            |\n  | 5xx    | [`InternalServerException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/InternalServerException.kt)       |\n  | others | [`UnexpectedStatusCodeException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/UnexpectedStatusCodeException.kt) |\n\n- [`Stainless4IoException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/Stainless4IoException.kt): I/O networking errors.\n\n- [`Stainless4RetryableException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/Stainless4RetryableException.kt): Generic error indicating a failure that could be retried by the client.\n\n- [`Stainless4InvalidDataException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/Stainless4InvalidDataException.kt): Failure to interpret successfully parsed data. For example,       when accessing a property that\'s supposed to be required, but the API unexpectedly omitted it from the       response.\n\n- [`Stainless4Exception`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/Stainless4Exception.kt): Base class for all exceptions. Most errors will result in one of the       previously mentioned ones, but completely generic errors may be thrown using the base class.\n\n## Pagination\n\nThe SDK defines methods that return a paginated lists of results. It provides convenient ways to access     the results either one page at a time or item-by-item across all pages.\n\n### Auto-pagination\n\nTo iterate through all results across all pages, use the `autoPager()` method, which automatically     fetches more pages as needed.\n\nWhen using the synchronous client, the method returns an [`Iterable`](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html)\n\n```java\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildListPage;\n\nBuildListPage page = client.builds().list();\n\n// Process as an Iterable\nfor (Build build : page.autoPager()) {\n    System.out.println(build);\n}\n\n// Process as a Stream\npage.autoPager()\n    .stream()\n    .limit(50)\n    .forEach(build -> System.out.println(build));\n```\n\nWhen using the asynchronous client, the method returns an [`AsyncStreamResponse`](stainless4-java-core/src/main/kotlin/com/stainless/api/core/http/AsyncStreamResponse.kt):\n\n```java\nimport com.stainless.api.core.http.AsyncStreamResponse;\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildListPageAsync;\nimport java.util.Optional;\nimport java.util.concurrent.CompletableFuture;\n\nCompletableFuture<BuildListPageAsync> pageFuture = client.async().builds().list();\n\npageFuture.thenRun(page -> page.autoPager().subscribe(build -> {\n    System.out.println(build);\n}));\n\n// If you need to handle errors or completion of the stream\npageFuture.thenRun(page -> page.autoPager().subscribe(new AsyncStreamResponse.Handler<>() {\n    @Override\n    public void onNext(Build build) {\n        System.out.println(build);\n    }\n\n    @Override\n    public void onComplete(Optional<Throwable> error) {\n        if (error.isPresent()) {\n            System.out.println("Something went wrong!");\n            throw new RuntimeException(error.get());\n        } else {\n            System.out.println("No more!");\n        }\n    }\n}));\n\n// Or use futures\npageFuture.thenRun(page -> page.autoPager()\n    .subscribe(build -> {\n        System.out.println(build);\n    })\n    .onCompleteFuture()\n    .whenComplete((unused, error) -> {\n        if (error != null) {\n            System.out.println("Something went wrong!");\n            throw new RuntimeException(error);\n        } else {\n            System.out.println("No more!");\n        }\n    }));\n```\n\n### Manual pagination\n\nTo access individual page items and manually request the next page, use the `items()`,\n`hasNextPage()`, and `nextPage()` methods:\n\n```java\nimport com.stainless.api.models.builds.Build;\nimport com.stainless.api.models.builds.BuildListPage;\n\nBuildListPage page = client.builds().list();\nwhile (true) {\n    for (Build build : page.items()) {\n        System.out.println(build);\n    }\n\n    if (!page.hasNextPage()) {\n        break;\n    }\n\n    page = page.nextPage();\n}\n```\n\n## Logging\n\nThe SDK uses the standard   [OkHttp logging interceptor](https://github.com/square/okhttp/tree/master/okhttp-logging-interceptor).\n\nEnable logging by setting the `STAINLESS4_LOG` environment variable to   `info`:\n\n```sh\nexport STAINLESS4_LOG=info\n```\n\nOr to `debug` for more verbose logging:\n\n```sh\nexport STAINLESS4_LOG=debug\n```\n\n## ProGuard and R8\n\nAlthough the SDK uses reflection, it is still usable with     [ProGuard](https://github.com/Guardsquare/proguard) and     [R8](https://developer.android.com/topic/performance/app-optimization/enable-app-optimization) because     `stainless4-java-core` is published with a     [configuration file](stainless4-java-core/src/main/resources/META-INF/proguard/stainless4-java-core.pro) containing     [keep rules](https://www.guardsquare.com/manual/configuration/usage).\n\nProGuard and R8 should automatically detect and use the published rules, but you can also manually copy     the keep rules if necessary.\n\n\n\n\n\n## Jackson\n\nThe SDK depends on [Jackson](https://github.com/FasterXML/jackson) for JSON     serialization/deserialization. It is compatible with version 2.13.4 or higher,     but depends on version 2.18.2 by default.\n\nThe SDK throws an exception if it detects an incompatible Jackson version at runtime (e.g. if the     default version was overridden in your Maven or Gradle config).\n\nIf the SDK threw an exception, but you\'re _certain_ the version is compatible, then disable the version     check using the `checkJacksonVersionCompatibility` on [`Stainless4OkHttpClient`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClient.kt) or     [`Stainless4OkHttpClientAsync`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClientAsync.kt).\n\n> [!CAUTION]\n> We make no guarantee that the SDK works correctly when the Jackson version check is disabled.\n\nAlso note that there are bugs in older Jackson versions that can affect the SDK. We don\'t work around all     Jackson bugs ([example](https://github.com/FasterXML/jackson-databind/issues/3240)) and expect users to     upgrade Jackson for those instead.\n\n## Network options\n\n### Retries\n\nThe SDK automatically retries 2 times by default, with a short exponential backoff between requests.\n\nOnly the following error types are retried:\n- Connection errors (for example, due to a network connectivity problem)\n- 408 Request Timeout\n- 409 Conflict\n- 429 Rate Limit\n- 5xx Internal\n\nThe API may also explicitly instruct the SDK to retry or not retry a request.\n\nTo set a custom number of retries, configure the client using the `maxRetries` method:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .maxRetries(4)\n    .build();\n```\n\n### Timeouts\n\nRequests time out after 1 minute by default.\n\nTo set a custom timeout, configure the method call using the `timeout` method:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild build = client.builds().create(\n  params, RequestOptions.builder().timeout(Duration.ofSeconds(30)).build()\n);\n```\n\nOr configure the default for all method calls at the client level:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\nimport java.time.Duration;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .timeout(Duration.ofSeconds(30))\n    .build();\n```\n\n### Proxies\n\nTo route requests through a proxy, configure the client using the `proxy` method:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\nimport java.net.InetSocketAddress;\nimport java.net.Proxy;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .proxy(new Proxy(\n      Proxy.Type.HTTP, new InetSocketAddress(\n        "https://example.com", 8080\n      )\n    ))\n    .build();\n```\n\n### Connection pooling\n\nTo customize the underlying OkHttp connection pool, configure the client using the   `maxIdleConnections` and `keepAliveDuration` methods:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\nimport java.time.Duration;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    // If `maxIdleConnections` is set, then `keepAliveDuration` must be set, and vice versa.\n    .maxIdleConnections(10)\n    .keepAliveDuration(Duration.ofMinutes(2))\n    .build();\n```\n\nIf both options are unset, OkHttp\'s default connection pool settings are used.\n\n### HTTPS\n\n> [!NOTE]\n> Most applications should not call these methods, and instead use the system defaults. The defaults include\n> special optimizations that can be lost if the implementations are modified.\n\nTo configure how HTTPS connections are secured, configure the client using the `sslSocketFactory`,   `trustManager`, and `hostnameVerifier` methods:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    // If `sslSocketFactory` is set, then `trustManager` must be set, and vice versa.\n    .sslSocketFactory(yourSSLSocketFactory)\n    .trustManager(yourTrustManager)\n    .hostnameVerifier(yourHostnameVerifier)\n    .build();\n```\n\n### Environments\n\nThe SDK sends requests to the production by default. To send requests to a different     environment, configure the client like so:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .staging()\n    .build();\n```\n\n### Custom HTTP client\n\nThe SDK consists of three artifacts:\n- `stainless4-java-core`\n  - Contains core SDK logic\n  - Does not depend on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless4Client`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4Client.kt), [`Stainless4ClientAsync`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientAsync.kt),             [`Stainless4ClientImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientImpl.kt), and [`Stainless4ClientAsyncImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientAsyncImpl.kt), all of which can             work with any HTTP client\n- `stainless4-java-client-okhttp`\n  - Depends on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless4OkHttpClient`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClient.kt) and [`Stainless4OkHttpClientAsync`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClientAsync.kt), which             provide a way to construct [`Stainless4ClientImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientImpl.kt) and             [`Stainless4ClientAsyncImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientAsyncImpl.kt), respectively, using OkHttp\n- `stainless4-java`\n  - Depends on and exposes the APIs of both `stainless4-java-core` and `stainless4-java-client-okhttp`\n  - Does not have its own logic\n\nThis structure allows replacing the SDK\'s default HTTP client without pulling in unnecessary dependencies.\n\n#### Customized [`OkHttpClient`](https://square.github.io/okhttp/3.x/okhttp/okhttp3/OkHttpClient.html)\n\n> [!TIP]\n> Try the available [network options](#network-options) before replacing the default client.\n\nTo use a customized `OkHttpClient`:\n\n1. Replace your [`stainless4-java` dependency](#installation) with `stainless4-java-core`\n2. Copy `stainless4-java-client-okhttp`\'s [`OkHttpClient`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/OkHttpClient.kt) class into your code and        customize it\n3. Construct [`Stainless4ClientImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientImpl.kt) or [`Stainless4ClientAsyncImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientAsyncImpl.kt), similarly to        [`Stainless4OkHttpClient`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClient.kt) or [`Stainless4OkHttpClientAsync`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClientAsync.kt), using your        customized client\n\n### Completely custom HTTP client\n\nTo use a completely custom HTTP client:\n\n1. Replace your [`stainless4-java` dependency](#installation) with `stainless4-java-core`\n2. Write a class that implements the [`HttpClient`](stainless4-java-core/src/main/kotlin/com/stainless/api/core/http/HttpClient.kt) interface\n3. Construct [`Stainless4ClientImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientImpl.kt) or [`Stainless4ClientAsyncImpl`](stainless4-java-core/src/main/kotlin/com/stainless/api/client/Stainless4ClientAsyncImpl.kt), similarly to        [`Stainless4OkHttpClient`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClient.kt) or [`Stainless4OkHttpClientAsync`](stainless4-java-client-okhttp/src/main/kotlin/com/stainless/api/client/okhttp/Stainless4OkHttpClientAsync.kt), using your new        client class\n\n## Undocumented API functionality\n\nThe SDK is typed for convenient usage of the documented API. However, it also supports working with undocumented or not yet supported parts of the API.\n\n### Parameters\n\nTo set undocumented parameters, call the `putAdditionalHeader`, `putAdditionalQueryParam`, or       `putAdditionalBodyProperty` methods on any `Params` class:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .putAdditionalHeader("Secret-Header", "42")\n    .putAdditionalQueryParam("secret_query_param", "42")\n    .putAdditionalBodyProperty("secretProperty", JsonValue.from("42"))\n    .build();\n```\n\nThese can be accessed on the built object later using the `_additionalHeaders()`,       `_additionalQueryParams()`, and `_additionalBodyProperties()` methods.\n\nTo set undocumented parameters on _nested_ headers, query params, or body classes, call the         `putAdditionalProperty` method on the nested class:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .targetCommitMessages(BuildCreateParams.TargetCommitMessages.builder()\n        .putAdditionalProperty("secretProperty", JsonValue.from("42"))\n        .build())\n    .build();\n```\n\nThese properties can be accessed on the nested built object later using the         `_additionalProperties()` method.\n\nTo set a documented parameter or property to an undocumented or not yet supported _value_, pass a       [`JsonValue`](stainless4-java-core/src/main/kotlin/com/stainless/api/core/Values.kt) object to its setter:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .project(JsonValue.from(42))\n    .revision("main")\n    .build();\n```\n\nThe most straightforward way to create a [`JsonValue`](stainless4-java-core/src/main/kotlin/com/stainless/api/core/Values.kt) is using its       `from(...)` method:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport java.util.List;\nimport java.util.Map;\n\n// Create primitive JSON values\nJsonValue nullValue = JsonValue.from(null);\nJsonValue booleanValue = JsonValue.from(true);\nJsonValue numberValue = JsonValue.from(42);\nJsonValue stringValue = JsonValue.from("Hello World!");\n\n// Create a JSON array value equivalent to `["Hello", "World"]`\nJsonValue arrayValue = JsonValue.from(List.of(\n  "Hello", "World"\n));\n\n// Create a JSON object value equivalent to `{ "a": 1, "b": 2 }`\nJsonValue objectValue = JsonValue.from(Map.of(\n  "a", 1,\n  "b", 2\n));\n\n// Create an arbitrarily nested JSON equivalent to:\n// {\n//   "a": [1, 2],\n//   "b": [3, 4]\n// }\nJsonValue complexValue = JsonValue.from(Map.of(\n  "a", List.of(\n    1, 2\n  ),\n  "b", List.of(\n    3, 4\n  )\n));\n```\n\nNormally a `Builder` class\'s `build` method will throw         [`IllegalStateException`](https://docs.oracle.com/javase/8/docs/api/java/lang/IllegalStateException.html)         if any required parameter or property is unset.\n\nTo forcibly omit a required parameter or property, pass [`JsonMissing`](stainless4-java-core/src/main/kotlin/com/stainless/api/core/Values.kt):\n\n```java\nimport com.stainless.api.core.JsonMissing;\nimport com.stainless.api.models.builds.BuildCreateParams;\n\nBuildCreateParams params = BuildCreateParams.builder()\n    .revision("string")\n    .project(JsonMissing.of())\n    .build();\n```\n\n### Response properties\n\nTo access undocumented response properties, call the `_additionalProperties()` method:\n\n```java\nimport com.stainless.api.core.JsonValue;\nimport java.util.Map;\n\nMap<String, JsonValue> additionalProperties = client.builds().create(params)._additionalProperties();\nJsonValue secretPropertyValue = additionalProperties.get("secretProperty");\n\nString result = secretPropertyValue.accept(new JsonValue.Visitor<>() {\n    @Override\n    public String visitNull() {\n        return "It\'s null!";\n    }\n\n    @Override\n    public String visitBoolean(boolean value) {\n        return "It\'s a boolean!";\n    }\n\n    @Override\n    public String visitNumber(Number value) {\n        return "It\'s a number!";\n    }\n\n    // Other methods include `visitMissing`, `visitString`, `visitArray`, and `visitObject`\n    // The default implementation of each unimplemented method delegates to `visitDefault`, which throws by default, but can also be overridden\n});\n```\n\nTo access a property\'s raw JSON value, which may be undocumented, call its `_` prefixed method:\n\n```java\nimport com.stainless.api.core.JsonField;\nimport java.util.Optional;\n\nJsonField<String> project = client.builds().create(params)._project();\n\nif (project.isMissing()) {\n  // The property is absent from the JSON response\n} else if (project.isNull()) {\n  // The property was set to literal null\n} else {\n  // Check if value was provided as a string\n  // Other methods include `asNumber()`, `asBoolean()`, etc.\n  Optional<String> jsonString = project.asString();\n\n  // Try to deserialize into a custom type\n  MyClass myObject = project.asUnknown().orElseThrow().convert(MyClass.class);\n}\n```\n\n### Response validation\n\nIn rare cases, the API may return a response that doesn\'t match the expected type. For example, the SDK     may expect a property to contain a `String`, but the API could return something else.\n\nBy default, the SDK will not throw an exception in this case. It will throw     [`Stainless4InvalidDataException`](stainless4-java-core/src/main/kotlin/com/stainless/api/errors/Stainless4InvalidDataException.kt) only if you directly access the property.\n\nIf you would prefer to check that the response is completely well-typed upfront, then either call     `validate()`:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild build = client.builds().create(params).validate();\n```\n\nOr configure the method call to validate the response using the `responseValidation` method:\n\n```java\nimport com.stainless.api.models.builds.Build;\n\nBuild build = client.builds().create(\n  params, RequestOptions.builder().responseValidation(true).build()\n);\n```\n\nOr configure the default for all method calls at the client level:\n\n```java\nimport com.stainless.api.client.Stainless4Client;\nimport com.stainless.api.client.okhttp.Stainless4OkHttpClient;\n\nStainless4Client client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .responseValidation(true)\n    .build();\n```\n\n## FAQ\n\n### Why don\'t you use plain `enum` classes?\n\nJava `enum` classes are not trivially   [forwards compatible](https://www.stainless.com/blog/making-java-enums-forwards-compatible). Using them in   the SDK could cause runtime exceptions if the API is updated to respond with a new enum value.\n\n### Why do you represent fields using `JsonField<T>` instead of just plain `T`?\n\nUsing `JsonField<T>` enables a few features:\n\n- Allowing usage of [undocumented API functionality](#undocumented-api-functionality)\n- Lazily [validating the API response against the expected shape](#response-validation)\n- Representing absent vs explicitly null values\n\n### Why don\'t you use [`data` classes](https://kotlinlang.org/docs/data-classes.html)?\n\nIt is not [backwards compatible to add new fields to a data class](https://kotlinlang.org/docs/api-guidelines-backward-compatibility.html#avoid-using-data-classes-in-your-api)   and we don\'t want to introduce a breaking change every time we add a field to a class.\n\n### Why don\'t you use checked exceptions?\n\nChecked exceptions are widely considered a mistake in the Java programming language. In fact, they were   omitted from Kotlin for this reason.\n\nChecked exceptions:\n\n- Are verbose to handle\n- Encourage error handling at the wrong level of abstraction, where nothing can be done about the error\n- Are tedious to propagate due to the [function coloring problem](https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function)\n- Don\'t play well with lambdas (also due to the function coloring problem)\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n2. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/stainless4-java/issues) with questions, bugs, or suggestions.\n',
  },
  {
    language: 'kotlin',
    content:
      '# Stainless4 Kotlin API Library\n\n\n[![Maven Central](https://img.shields.io/maven-central/v/com.configure_me_stainless_v0.api/stainless4-kotlin)](https://central.sonatype.com/artifact/com.configure_me_stainless_v0.api/stainless4-kotlin/0.0.1)\n[![javadoc](https://javadoc.io/badge2/com.configure_me_stainless_v0.api/stainless4-kotlin/0.0.1/javadoc.svg)](https://javadoc.io/doc/com.configure_me_stainless_v0.api/stainless4-kotlin/0.0.1)\n\n\nThe Stainless4 Kotlin SDK provides convenient access to the [Stainless4 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli)   from applications written in Kotlin.\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Stainless4 MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40stainless-api%2Fsdk-mcp&config=eyJuYW1lIjoiQHN0YWlubGVzcy1hcGkvc2RrLW1jcCIsInRyYW5zcG9ydCI6Imh0dHAiLCJ1cmwiOiJodHRwczovL3N0YWlubGVzczQuc3RsbWNwLmNvbSIsImhlYWRlcnMiOnsieC1zdGFpbmxlc3MtYXBpLWtleSI6Ik15IEFQSSBLZXkifX0)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22%40stainless-api%2Fsdk-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fstainless4.stlmcp.com%22%2C%22headers%22%3A%7B%22x-stainless-api-key%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\nThe REST API documentation can be found on [www.stainless.com](https://www.stainless.com/docs/getting-started/quickstart-cli). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.configure_me_stainless_v0.api/stainless4-kotlin/0.0.1).\n\n## Installation\n\n### Gradle\n\n~~~kotlin\nimplementation("com.CONFIGURE_ME_stainless_v0.api:stainless4-kotlin:0.0.1")\n~~~\n\n### Maven\n\n~~~xml\n<dependency>\n  <groupId>com.CONFIGURE_ME_stainless_v0.api</groupId>\n  <artifactId>stainless4-kotlin</artifactId>\n  <version>0.0.1</version>\n</dependency>\n~~~\n\n## Requirements\n\nThis library requires Java 8 or later.\n\n## Usage\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nval client: Stainless4Client = Stainless4OkHttpClient.fromEnv()\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: Build = client.builds().create(params)\n```\n\n## Client configuration\n\nConfigure the client using system properties or environment variables:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nval client: Stainless4Client = Stainless4OkHttpClient.fromEnv()\n```\n\nOr manually:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .apiKey("My API Key")\n    .build()\n```\n\nOr using a combination of the two approaches:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    // Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n    // Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\n    .fromEnv()\n    .project("example-project")\n    .build()\n```\n\nSee this table for the available options:\n\n| Setter    | System property              | Environment variable  | Required | Default value                 |\n| --------- | ---------------------------- | --------------------- | -------- | ----------------------------- |\n| `apiKey`  | `stainless4.stainlessApiKey` | `STAINLESS_API_KEY`   | false    | -                             |\n| `baseUrl` | `stainless4.baseUrl`         | `STAINLESS4_BASE_URL` | true     | `"https://api.stainless.com"` |\n\nSystem properties take precedence over environment variables.\n\n> [!TIP]\n> Don\'t create more than one client in the same application. Each client has a connection pool and\n> thread pools, which are more efficient to share between requests.\n\n### Modifying configuration\n\nTo temporarily use a modified client configuration, while reusing the same connection and thread       pools, call `withOptions()` on any client or service:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\n\nval clientWithOptions: Stainless4Client = client.withOptions {\n    it.baseUrl("https://example.com")\n    it.maxRetries(42)\n}\n```\n\nThe `withOptions()` method does not affect the original client or service.\n\n## Requests and responses\n\nTo send a request to the Stainless4 API, build an instance of some `Params` class and pass it to the     corresponding client method. When the response is received, it will be deserialized into an instance of     a Kotlin class.\n\nFor example, `client.builds().create(...)` should be called with an instance of `BuildCreateParams`, and it     will return an instance of `Build`.\n\n## Immutability\n\nEach class in the SDK has an associated   [builder](https://blogs.oracle.com/javamagazine/post/exploring-joshua-blochs-builder-design-pattern-in-java)   or factory method for constructing it.\n\nEach class is [immutable](https://docs.oracle.com/javase/tutorial/essential/concurrency/immutable.html)   once constructed. If the class has an associated builder, then it has a `toBuilder()` method, which can   be used to convert it back to a builder for making a modified copy.\n\nBecause each class is immutable, builder modification will _never_ affect already built class instances.\n\n## Asynchronous execution\n\nThe default client is synchronous. To switch to asynchronous execution, call the `async()` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nval client: Stainless4Client = Stainless4OkHttpClient.fromEnv()\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: Build = client.async().builds().create(params)\n```\n\nOr create an asynchronous client from the beginning:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4ClientAsync\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClientAsync\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\n// Configures using the `stainless4.stainlessApiKey` and `stainless4.baseUrl` system properties\n// Or configures using the `STAINLESS_API_KEY` and `STAINLESS4_BASE_URL` environment variables\nval client: Stainless4ClientAsync = Stainless4OkHttpClientAsync.fromEnv()\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: Build = client.builds().create(params)\n```\n\nThe asynchronous client supports the same options as the synchronous one, except most methods are [suspending](https://kotlinlang.org/docs/coroutines-guide.html).\n\n\n\n\n\n\n\n## Raw responses\n\nThe SDK defines methods that deserialize responses into instances of Kotlin classes.       However, these methods don\'t provide access to the response headers, status code, or the raw response       body.\n\nTo access this data, prefix any HTTP method call on a client or service with `withRawResponse()`:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.http.Headers\nimport com.configure_me_stainless_v0.api.core.http.HttpResponseFor\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project("stainless")\n    .revision("main")\n    .build()\nval build: HttpResponseFor<Build> = client.builds().withRawResponse().create(params)\n\nval statusCode: Int = build.statusCode()\nval headers: Headers = build.headers()\n```\n\nYou can still deserialize the response into an instance of a Kotlin class if needed:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval parsedBuild: Build = build.parse()\n```\n\n## Error handling\n\nThe SDK throws custom unchecked exception types:\n\n- [`Stainless4ServiceException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless4ServiceException.kt): Base class for HTTP errors. See this table for which exception       subclass is thrown for each HTTP status code:\n\n  | Status | Exception                                          |\n  | ------ | -------------------------------------------------- |\n  | 400    | [`BadRequestException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/BadRequestException.kt)           |\n  | 401    | [`UnauthorizedException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/UnauthorizedException.kt)         |\n  | 403    | [`PermissionDeniedException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/PermissionDeniedException.kt)     |\n  | 404    | [`NotFoundException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/NotFoundException.kt)             |\n  | 422    | [`UnprocessableEntityException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/UnprocessableEntityException.kt)  |\n  | 429    | [`RateLimitException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/RateLimitException.kt)            |\n  | 5xx    | [`InternalServerException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/InternalServerException.kt)       |\n  | others | [`UnexpectedStatusCodeException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/UnexpectedStatusCodeException.kt) |\n\n- [`Stainless4IoException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless4IoException.kt): I/O networking errors.\n\n- [`Stainless4RetryableException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless4RetryableException.kt): Generic error indicating a failure that could be retried by the client.\n\n- [`Stainless4InvalidDataException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless4InvalidDataException.kt): Failure to interpret successfully parsed data. For example,       when accessing a property that\'s supposed to be required, but the API unexpectedly omitted it from the       response.\n\n- [`Stainless4Exception`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless4Exception.kt): Base class for all exceptions. Most errors will result in one of the       previously mentioned ones, but completely generic errors may be thrown using the base class.\n\n## Pagination\n\nThe SDK defines methods that return a paginated lists of results. It provides convenient ways to access     the results either one page at a time or item-by-item across all pages.\n\n### Auto-pagination\n\nTo iterate through all results across all pages, use the `autoPager()` method, which automatically     fetches more pages as needed.\n\nWhen using the synchronous client, the method returns a [`Sequence`](https://kotlinlang.org/docs/sequences.html)\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.BuildListPage\n\nval page: BuildListPage = client.builds().list()\npage.autoPager()\n    .take(50)\n    .forEach { build -> println(build) }\n```\n\nWhen using the asynchronous client, the method returns a [`Flow`](https://kotlinlang.org/docs/flow.html):\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.BuildListPageAsync\n\nval page: BuildListPageAsync = client.async().builds().list()\npage.autoPager()\n    .take(50)\n    .forEach { build -> println(build) }\n```\n\n### Manual pagination\n\nTo access individual page items and manually request the next page, use the `items()`,\n`hasNextPage()`, and `nextPage()` methods:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\nimport com.configure_me_stainless_v0.api.models.builds.BuildListPage\n\nval page: BuildListPage = client.builds().list()\nwhile (true) {\n    for (build in page.items()) {\n        println(build)\n    }\n\n    if (!page.hasNextPage()) {\n        break\n    }\n\n    page = page.nextPage()\n}\n```\n\n## Logging\n\nThe SDK uses the standard   [OkHttp logging interceptor](https://github.com/square/okhttp/tree/master/okhttp-logging-interceptor).\n\nEnable logging by setting the `STAINLESS4_LOG` environment variable to   `info`:\n\n```sh\nexport STAINLESS4_LOG=info\n```\n\nOr to `debug` for more verbose logging:\n\n```sh\nexport STAINLESS4_LOG=debug\n```\n\n## ProGuard and R8\n\nAlthough the SDK uses reflection, it is still usable with     [ProGuard](https://github.com/Guardsquare/proguard) and     [R8](https://developer.android.com/topic/performance/app-optimization/enable-app-optimization) because     `stainless4-kotlin-core` is published with a     [configuration file](stainless4-kotlin-core/src/main/resources/META-INF/proguard/stainless4-kotlin-core.pro) containing     [keep rules](https://www.guardsquare.com/manual/configuration/usage).\n\nProGuard and R8 should automatically detect and use the published rules, but you can also manually copy     the keep rules if necessary.\n\n\n\n\n\n## Jackson\n\nThe SDK depends on [Jackson](https://github.com/FasterXML/jackson) for JSON     serialization/deserialization. It is compatible with version 2.13.4 or higher,     but depends on version 2.18.2 by default.\n\nThe SDK throws an exception if it detects an incompatible Jackson version at runtime (e.g. if the     default version was overridden in your Maven or Gradle config).\n\nIf the SDK threw an exception, but you\'re _certain_ the version is compatible, then disable the version     check using the `checkJacksonVersionCompatibility` on [`Stainless4OkHttpClient`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClient.kt) or     [`Stainless4OkHttpClientAsync`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClientAsync.kt).\n\n> [!CAUTION]\n> We make no guarantee that the SDK works correctly when the Jackson version check is disabled.\n\nAlso note that there are bugs in older Jackson versions that can affect the SDK. We don\'t work around all     Jackson bugs ([example](https://github.com/FasterXML/jackson-databind/issues/3240)) and expect users to     upgrade Jackson for those instead.\n\n## Network options\n\n### Retries\n\nThe SDK automatically retries 2 times by default, with a short exponential backoff between requests.\n\nOnly the following error types are retried:\n- Connection errors (for example, due to a network connectivity problem)\n- 408 Request Timeout\n- 409 Conflict\n- 429 Rate Limit\n- 5xx Internal\n\nThe API may also explicitly instruct the SDK to retry or not retry a request.\n\nTo set a custom number of retries, configure the client using the `maxRetries` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .maxRetries(4)\n    .build()\n```\n\n### Timeouts\n\nRequests time out after 1 minute by default.\n\nTo set a custom timeout, configure the method call using the `timeout` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval build: Build = client.builds().create(\n  params, RequestOptions.builder().timeout(Duration.ofSeconds(30)).build()\n)\n```\n\nOr configure the default for all method calls at the client level:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\nimport java.time.Duration\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .timeout(Duration.ofSeconds(30))\n    .build()\n```\n\n### Proxies\n\nTo route requests through a proxy, configure the client using the `proxy` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\nimport java.net.InetSocketAddress\nimport java.net.Proxy\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .proxy(Proxy(\n      Proxy.Type.HTTP, InetSocketAddress(\n        "https://example.com", 8080\n      )\n    ))\n    .build()\n```\n\n### Connection pooling\n\nTo customize the underlying OkHttp connection pool, configure the client using the   `maxIdleConnections` and `keepAliveDuration` methods:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\nimport java.time.Duration\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    // If `maxIdleConnections` is set, then `keepAliveDuration` must be set, and vice versa.\n    .maxIdleConnections(10)\n    .keepAliveDuration(Duration.ofMinutes(2))\n    .build()\n```\n\nIf both options are unset, OkHttp\'s default connection pool settings are used.\n\n### HTTPS\n\n> [!NOTE]\n> Most applications should not call these methods, and instead use the system defaults. The defaults include\n> special optimizations that can be lost if the implementations are modified.\n\nTo configure how HTTPS connections are secured, configure the client using the `sslSocketFactory`,   `trustManager`, and `hostnameVerifier` methods:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    // If `sslSocketFactory` is set, then `trustManager` must be set, and vice versa.\n    .sslSocketFactory(yourSSLSocketFactory)\n    .trustManager(yourTrustManager)\n    .hostnameVerifier(yourHostnameVerifier)\n    .build()\n```\n\n### Environments\n\nThe SDK sends requests to the production by default. To send requests to a different     environment, configure the client like so:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .staging()\n    .build()\n```\n\n### Custom HTTP client\n\nThe SDK consists of three artifacts:\n- `stainless4-kotlin-core`\n  - Contains core SDK logic\n  - Does not depend on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless4Client`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4Client.kt), [`Stainless4ClientAsync`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientAsync.kt),             [`Stainless4ClientImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientImpl.kt), and [`Stainless4ClientAsyncImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientAsyncImpl.kt), all of which can             work with any HTTP client\n- `stainless4-kotlin-client-okhttp`\n  - Depends on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`Stainless4OkHttpClient`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClient.kt) and [`Stainless4OkHttpClientAsync`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClientAsync.kt), which             provide a way to construct [`Stainless4ClientImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientImpl.kt) and             [`Stainless4ClientAsyncImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientAsyncImpl.kt), respectively, using OkHttp\n- `stainless4-kotlin`\n  - Depends on and exposes the APIs of both `stainless4-kotlin-core` and `stainless4-kotlin-client-okhttp`\n  - Does not have its own logic\n\nThis structure allows replacing the SDK\'s default HTTP client without pulling in unnecessary dependencies.\n\n#### Customized [`OkHttpClient`](https://square.github.io/okhttp/3.x/okhttp/okhttp3/OkHttpClient.html)\n\n> [!TIP]\n> Try the available [network options](#network-options) before replacing the default client.\n\nTo use a customized `OkHttpClient`:\n\n1. Replace your [`stainless4-kotlin` dependency](#installation) with `stainless4-kotlin-core`\n2. Copy `stainless4-kotlin-client-okhttp`\'s [`OkHttpClient`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/OkHttpClient.kt) class into your code and        customize it\n3. Construct [`Stainless4ClientImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientImpl.kt) or [`Stainless4ClientAsyncImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientAsyncImpl.kt), similarly to        [`Stainless4OkHttpClient`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClient.kt) or [`Stainless4OkHttpClientAsync`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClientAsync.kt), using your        customized client\n\n### Completely custom HTTP client\n\nTo use a completely custom HTTP client:\n\n1. Replace your [`stainless4-kotlin` dependency](#installation) with `stainless4-kotlin-core`\n2. Write a class that implements the [`HttpClient`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/http/HttpClient.kt) interface\n3. Construct [`Stainless4ClientImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientImpl.kt) or [`Stainless4ClientAsyncImpl`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/client/Stainless4ClientAsyncImpl.kt), similarly to        [`Stainless4OkHttpClient`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClient.kt) or [`Stainless4OkHttpClientAsync`](stainless4-kotlin-client-okhttp/src/main/kotlin/com/configure_me_stainless_v0/api/client/okhttp/Stainless4OkHttpClientAsync.kt), using your new        client class\n\n## Undocumented API functionality\n\nThe SDK is typed for convenient usage of the documented API. However, it also supports working with undocumented or not yet supported parts of the API.\n\n### Parameters\n\nTo set undocumented parameters, call the `putAdditionalHeader`, `putAdditionalQueryParam`, or       `putAdditionalBodyProperty` methods on any `Params` class:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .putAdditionalHeader("Secret-Header", "42")\n    .putAdditionalQueryParam("secret_query_param", "42")\n    .putAdditionalBodyProperty("secretProperty", JsonValue.from("42"))\n    .build()\n```\n\nThese can be accessed on the built object later using the `_additionalHeaders()`,       `_additionalQueryParams()`, and `_additionalBodyProperties()` methods.\n\nTo set undocumented parameters on _nested_ headers, query params, or body classes, call the         `putAdditionalProperty` method on the nested class:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .targetCommitMessages(BuildCreateParams.TargetCommitMessages.builder()\n        .putAdditionalProperty("secretProperty", JsonValue.from("42"))\n        .build())\n    .build()\n```\n\nThese properties can be accessed on the nested built object later using the         `_additionalProperties()` method.\n\nTo set a documented parameter or property to an undocumented or not yet supported _value_, pass a       [`JsonValue`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/Values.kt) object to its setter:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .project(JsonValue.from(42))\n    .revision("main")\n    .build()\n```\n\nThe most straightforward way to create a [`JsonValue`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/Values.kt) is using its       `from(...)` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonValue\n\n// Create primitive JSON values\nval nullValue: JsonValue = JsonValue.from(null)\nval booleanValue: JsonValue = JsonValue.from(true)\nval numberValue: JsonValue = JsonValue.from(42)\nval stringValue: JsonValue = JsonValue.from("Hello World!")\n\n// Create a JSON array value equivalent to `["Hello", "World"]`\nval arrayValue: JsonValue = JsonValue.from(listOf(\n  "Hello", "World"\n))\n\n// Create a JSON object value equivalent to `{ "a": 1, "b": 2 }`\nval objectValue: JsonValue = JsonValue.from(mapOf(\n  "a" to 1, "b" to 2\n))\n\n// Create an arbitrarily nested JSON equivalent to:\n// {\n//   "a": [1, 2],\n//   "b": [3, 4]\n// }\nval complexValue: JsonValue = JsonValue.from(mapOf(\n  "a" to listOf(\n    1, 2\n  ), "b" to listOf(\n    3, 4\n  )\n))\n```\n\nNormally a `Builder` class\'s `build` method will throw         [`IllegalStateException`](https://docs.oracle.com/javase/8/docs/api/java/lang/IllegalStateException.html)         if any required parameter or property is unset.\n\nTo forcibly omit a required parameter or property, pass [`JsonMissing`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/core/Values.kt):\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonMissing\nimport com.configure_me_stainless_v0.api.models.builds.BuildCreateParams\n\nval params: BuildCreateParams = BuildCreateParams.builder()\n    .revision("string")\n    .project(JsonMissing.of())\n    .build()\n```\n\n### Response properties\n\nTo access undocumented response properties, call the `_additionalProperties()` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonBoolean\nimport com.configure_me_stainless_v0.api.core.JsonNull\nimport com.configure_me_stainless_v0.api.core.JsonNumber\nimport com.configure_me_stainless_v0.api.core.JsonValue\n\nval additionalProperties: Map<String, JsonValue> = client.builds().create(params)._additionalProperties()\nval secretPropertyValue: JsonValue = additionalProperties.get("secretProperty")\n\nval result = when (secretPropertyValue) {\n    is JsonNull -> "It\'s null!"\n    is JsonBoolean -> "It\'s a boolean!"\n    is JsonNumber -> "It\'s a number!"\n    // Other types include `JsonMissing`, `JsonString`, `JsonArray`, and `JsonObject`\n    else -> "It\'s something else!"\n}\n```\n\nTo access a property\'s raw JSON value, which may be undocumented, call its `_` prefixed method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.core.JsonField\n\nval project: JsonField<String> = client.builds().create(params)._project()\n\nif (project.isMissing()) {\n  // The property is absent from the JSON response\n} else if (project.isNull()) {\n  // The property was set to literal null\n} else {\n  // Check if value was provided as a string\n  // Other methods include `asNumber()`, `asBoolean()`, etc.\n  val jsonString: String? = project.asString();\n\n  // Try to deserialize into a custom type\n  val myObject: MyClass = project.asUnknown()!!.convert(MyClass::class.java)\n}\n```\n\n### Response validation\n\nIn rare cases, the API may return a response that doesn\'t match the expected type. For example, the SDK     may expect a property to contain a `String`, but the API could return something else.\n\nBy default, the SDK will not throw an exception in this case. It will throw     [`Stainless4InvalidDataException`](stainless4-kotlin-core/src/main/kotlin/com/configure_me_stainless_v0/api/errors/Stainless4InvalidDataException.kt) only if you directly access the property.\n\nIf you would prefer to check that the response is completely well-typed upfront, then either call     `validate()`:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval build: Build = client.builds().create(params).validate()\n```\n\nOr configure the method call to validate the response using the `responseValidation` method:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.models.builds.Build\n\nval build: Build = client.builds().create(\n  params, RequestOptions.builder().responseValidation(true).build()\n)\n```\n\nOr configure the default for all method calls at the client level:\n\n```kotlin\nimport com.configure_me_stainless_v0.api.client.Stainless4Client\nimport com.configure_me_stainless_v0.api.client.okhttp.Stainless4OkHttpClient\n\nval client: Stainless4Client = Stainless4OkHttpClient.builder()\n    .fromEnv()\n    .responseValidation(true)\n    .build()\n```\n\n## FAQ\n\n### Why don\'t you use plain `enum` classes?\n\nKotlin `enum` classes are not trivially   [forwards compatible](https://www.stainless.com/blog/making-java-enums-forwards-compatible). Using them in   the SDK could cause runtime exceptions if the API is updated to respond with a new enum value.\n\n### Why do you represent fields using `JsonField<T>` instead of just plain `T`?\n\nUsing `JsonField<T>` enables a few features:\n\n- Allowing usage of [undocumented API functionality](#undocumented-api-functionality)\n- Lazily [validating the API response against the expected shape](#response-validation)\n- Representing absent vs explicitly null values\n\n### Why don\'t you use [`data` classes](https://kotlinlang.org/docs/data-classes.html)?\n\nIt is not [backwards compatible to add new fields to a data class](https://kotlinlang.org/docs/api-guidelines-backward-compatibility.html#avoid-using-data-classes-in-your-api)   and we don\'t want to introduce a breaking change every time we add a field to a class.\n\n### Why don\'t you use checked exceptions?\n\nChecked exceptions are widely considered a mistake in the Java programming language. In fact, they were   omitted from Kotlin for this reason.\n\nChecked exceptions:\n\n- Are verbose to handle\n- Encourage error handling at the wrong level of abstraction, where nothing can be done about the error\n- Are tedious to propagate due to the [function coloring problem](https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function)\n- Don\'t play well with lambdas (also due to the function coloring problem)\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n2. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/stainless4-kotlin/issues) with questions, bugs, or suggestions.\n',
  },
  {
    language: 'csharp',
    content:
      '# Stainless4 C# API Library\n\nThe Stainless4 C# SDK provides convenient access to the [Stainless4 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli) from applications written in   C#.\n\n## Installation\n\n```bash\ngit clone git@github.com:stainless-sdks/stainless4-csharp.git\ndotnet add reference stainless4-csharp/src/StainlessV0\n```\n\n## Requirements\n\nThis library requires .NET Standard 2.0 or later.\n\n## Usage\n\nSee the [`examples`](examples) directory for complete and runnable examples.\n\n```csharp\nStainless4Client client = new();\n\nBuildCreateParams parameters = new()\n{\n    Project = "stainless",\n    Revision = "main",\n};\n\nvar build = await client.Builds.Create(parameters);\n\nConsole.WriteLine(build);\n```',
  },
  {
    language: 'cli',
    content:
      "# Stainless4 CLI\n\nThe official CLI for the [Stainless4 REST API](https://www.stainless.com/docs/getting-started/quickstart-cli).\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n<!-- x-release-please-start-version -->\n\n## Installation\n\n### Installing with Homebrew\n\n~~~sh\nbrew install stainless-api/tap/stl\n~~~\n\n### Installing with Go\n\nTo test or install the CLI locally, you need [Go](https://go.dev/doc/install) version 1.22 or later installed.\n\n~~~sh\ngo install 'github.com/stainless-api/stainless-api-cli/cmd/stl@latest'\n~~~\n\nOnce you have run `go install`, the binary is placed in your Go bin directory:\n\n- **Default location**: `$HOME/go/bin` (or `$GOPATH/bin` if GOPATH is set)\n- **Check your path**: Run `go env GOPATH` to see the base directory\n\nIf commands aren't found after installation, add the Go bin directory to your PATH:\n\n~~~sh\n# Add to your shell profile (.zshrc, .bashrc, etc.)\nexport PATH=\"$PATH:$(go env GOPATH)/bin\"\n~~~\n\n<!-- x-release-please-end -->\n\n### Running Locally\n\nAfter cloning the git repository for this project, you can use the\n`scripts/run` script to run the tool locally:\n\n~~~sh\n./scripts/run args...\n~~~\n\n## Usage\n\nThe CLI follows a resource-based command structure:\n\n~~~sh\nstl [resource] <command> [flags...]\n~~~\n\n~~~sh\nstl builds create \\\n  --api-key 'My API Key' \\\n  --project stainless \\\n  --revision main\n~~~\n\nFor details about specific commands, use the `--help` flag.\n\n### Environment variables\n\n| Environment variable | Required | Default value |\n| -------------------- | -------- | ------------- |\n| `STAINLESS_API_KEY`  | no       | `null`        |\n\n### Global flags\n\n- `--api-key` (can also be set with `STAINLESS_API_KEY` env var)\n- `--project`\n- `--help` - Show command line usage\n- `--debug` - Enable debug logging (includes HTTP request/response details)\n- `--version`, `-v` - Show the CLI version\n- `--base-url` - Use a custom API backend URL\n- `--format` - Change the output format (`auto`, `explore`, `json`, `jsonl`, `pretty`, `raw`, `yaml`)\n- `--format-error` - Change the output format for errors (`auto`, `explore`, `json`, `jsonl`, `pretty`, `raw`, `yaml`)\n- `--transform` - Transform the data output using [GJSON syntax](https://github.com/tidwall/gjson/blob/master/SYNTAX.md)\n- `--transform-error` - Transform the error output using [GJSON syntax](https://github.com/tidwall/gjson/blob/master/SYNTAX.md)\n\n### Passing files as arguments\n\nTo pass files to your API, you can use the `@myfile.ext` syntax:\n\n~~~bash\nstl <command> --arg @abe.jpg\n~~~\n\nFiles can also be passed inside JSON or YAML blobs:\n\n~~~bash\nstl <command> --arg '{image: \"@abe.jpg\"}'\n# Equivalent:\nstl <command> <<YAML\narg:\n  image: \"@abe.jpg\"\nYAML\n~~~\n\nIf you need to pass a string literal that begins with an `@` sign, you can\nescape the `@` sign to avoid accidentally passing a file.\n\n~~~bash\nstl <command> --username '\\@abe'\n~~~\n\n#### Explicit encoding\n\nFor JSON endpoints, the CLI tool does filetype sniffing to determine whether the\nfile contents should be sent as a string literal (for plain text files) or as a\nbase64-encoded string literal (for binary files). If you need to explicitly send\nthe file as either plain text or base64-encoded data, you can use\n`@file://myfile.txt` (for string encoding) or `@data://myfile.dat` (for\nbase64-encoding). Note that absolute paths will begin with `@file://` or\n`@data://`, followed by a third `/` (for example, `@file:///tmp/file.txt`).\n\n~~~bash\nstl <command> --arg @data://file.txt\n~~~\n",
  },
  {
    language: 'php',
    content:
      '# Stainless4 PHP API Library\n\nThe Stainless4 PHP library provides convenient access to the Stainless4 REST API from any PHP 8.1.0+ application.\n\n## Installation\n\nTo use this package, install via Composer by adding the following to your application\'s `composer.json`:\n\n```json\n{\n  "repositories": [\n    {\n      "type": "vcs",\n      "url": "git@github.com:stainless-sdks/stainless4-php.git"\n    }\n  ],\n  "require": {\n    "org-placeholder/stainless-v0": "dev-main"\n  }\n}\n```\n\n## Usage\n\n```php\n<?php\n\n$client = new Client(\n  apiKey: getenv(\'STAINLESS_API_KEY\') ?: \'My API Key\', environment: \'staging\'\n);\n\n$build = $client->builds->create(project: \'stainless\', revision: \'main\');\n\nvar_dump($build->id);\n```',
  },
];
