...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ config_repo: string; display_name: string; object: 'project'; org: string; slug: string; targets: string[]; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Projects.Retrieve",
        "example": "ProjectRetrieveParams parameters = new() { Project = \"project\" };\n\nvar project = await client.Projects.Retrieve(parameters);\n\nConsole.WriteLine(project);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Projects.Update",
        "example": "ProjectUpdateParams parameters = new() { Project = \"project\" };\n\nvar project = await client.Projects.Update(parameters);\n\nConsole.WriteLine(project);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT \\\n    -X PATCH \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Projects.List",
        "example": "ProjectListParams parameters = new();\n\nvar page = await client.Projects.List(parameters);\nawait foreach (var item in page.Paginate())\n{\n    Console.WriteLine(item);\n}"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "projects generate_commit_message",
        "example": "stl projects generate-commit-message \\\n  --api-key 'My API Key' \\\n  --project project \\\n  --target python \\\n  --base-ref base_ref \\\n  --head-ref head_ref"
      },
      "php": {
        "method": "projects->generateCommitMessage",
      ...
      "csharp": {
        "method": "Projects.GenerateCommitMessage",
        "example": "ProjectGenerateCommitMessageParams parameters = new()\n{\n    Project = \"project\",\n    Target = Target.Python,\n    BaseRef = \"base_ref\",\n    HeadRef = \"head_ref\",\n};\n\nvar response = await client.Projects.GenerateCommitMessage(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/generate_commit_message \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\" \\\n    -d '{\n          \"base_ref\": \"base_ref\",\n          \"head_ref\": \"head_ref\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "stl projects:branches create \\\n  --api-key 'My API Key' \\\n  --project project \\\n  --branch branch \\\n  --branch-from branch_from"
      },
      "php": {
        "method": "projects->branches->create",
      ...
      "csharp": {
        "method": "Projects.Branches.Create",
        "example": "BranchCreateParams parameters = new()\n{\n    Project = \"project\",\n    Branch = \"branch\",\n    BranchFrom = \"branch_from\",\n};\n\nvar projectBranch = await client.Projects.Branches.Create(parameters);\n\nConsole.WriteLine(projectBranch);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/branches \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\" \\\n    -d '{\n          \"branch\": \"branch\",\n          \"branch_from\": \"branch_from\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "stl projects:branches retrieve \\\n  --api-key 'My API Key' \\\n  --project project \\\n  --branch branch"
      },
      "php": {
        "method": "projects->branches->retrieve",
      ...
      "csharp": {
        "method": "Projects.Branches.Retrieve",
        "example": "BranchRetrieveParams parameters = new()\n{\n    Project = \"project\",\n    Branch = \"branch\",\n};\n\nvar projectBranch = await client.Projects.Branches.Retrieve(parameters);\n\nConsole.WriteLine(projectBranch);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/branches/$BRANCH \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ branch: string; config_commit: { repo: { branch: string; host: string; name: string; owner: string; }; sha: string; stats: { additions: number; deletions: number; total: number; }; tree_oid: string; }; latest_build_id: string; object: 'project_branch'; org: string; project: string; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Projects.Branches.List",
        "example": "BranchListParams parameters = new() { Project = \"project\" };\n\nvar page = await client.Projects.Branches.List(parameters);\nawait foreach (var item in page.Paginate())\n{\n    Console.WriteLine(item);\n}"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/branches \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "stl projects:branches delete \\\n  --api-key 'My API Key' \\\n  --project project \\\n  --branch branch"
      },
      "php": {
        "method": "projects->branches->delete",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "stl projects:branches rebase \\\n  --api-key 'My API Key' \\\n  --project project \\\n  --branch branch"
      },
      "php": {
        "method": "projects->branches->rebase",
      ...
      "csharp": {
        "method": "Projects.Branches.Rebase",
        "example": "BranchRebaseParams parameters = new()\n{\n    Project = \"project\",\n    Branch = \"branch\",\n};\n\nvar projectBranch = await client.Projects.Branches.Rebase(parameters);\n\nConsole.WriteLine(projectBranch);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/branches/$BRANCH/rebase \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "stl projects:branches reset \\\n  --api-key 'My API Key' \\\n  --project project \\\n  --branch branch"
      },
      "php": {
        "method": "projects->branches->reset",
      ...
      "csharp": {
        "method": "Projects.Branches.Reset",
        "example": "BranchResetParams parameters = new()\n{\n    Project = \"project\",\n    Branch = \"branch\",\n};\n\nvar projectBranch = await client.Projects.Branches.Reset(parameters);\n\nConsole.WriteLine(projectBranch);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/branches/$BRANCH/reset \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Projects.Configs.Retrieve",
        "example": "ConfigRetrieveParams parameters = new() { Project = \"project\" };\n\nvar config = await client.Projects.Configs.Retrieve(parameters);\n\nConsole.WriteLine(config);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/configs \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "stl projects:configs guess \\\n  --api-key 'My API Key' \\\n  --project project \\\n  --spec spec"
      },
      "php": {
        "method": "projects->configs->guess",
      ...
      "csharp": {
        "method": "Projects.Configs.Guess",
        "example": "ConfigGuessParams parameters = new()\n{\n    Project = \"project\",\n    Spec = \"spec\",\n};\n\nvar response = await client.Projects.Configs.Guess(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/projects/$PROJECT/configs/guess \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\" \\\n    -d '{\n          \"spec\": \"spec\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Builds.List",
        "example": "BuildListParams parameters = new() { Project = \"project\" };\n\nvar page = await client.Builds.List(parameters);\nawait foreach (var item in page.Paginate())\n{\n    Console.WriteLine(item);\n}"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/builds \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Builds.Retrieve",
        "example": "BuildRetrieveParams parameters = new() { BuildID = \"buildId\" };\n\nvar build = await client.Builds.Retrieve(parameters);\n\nConsole.WriteLine(build);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/builds/$BUILD_ID \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Builds.Compare",
        "example": "BuildCompareParams parameters = new()\n{\n    Base = new()\n    {\n        Branch = \"branch\",\n        Revision = \"string\",\n        CommitMessage = \"commit_message\",\n    },\n    Head = new()\n    {\n        Branch = \"branch\",\n        Revision = \"string\",\n        CommitMessage = \"commit_message\",\n    },\n    Project = \"project\",\n};\n\nvar response = await client.Builds.Compare(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/builds/compare \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\" \\\n    -d '{\n          \"base\": {\n            \"branch\": \"branch\",\n            \"revision\": \"string\"\n          },\n          \"head\": {\n            \"branch\": \"branch\",\n            \"revision\": \"string\"\n          },\n          \"project\": \"project\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ code: string; ignored: boolean; level: 'fatal' | 'error' | 'warning' | 'note'; message: string; more: { markdown: string; type: 'markdown'; } | { raw: string; type: 'raw'; }; config_ref?: string; oas_ref?: string; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Builds.Diagnostics.List",
        "example": "DiagnosticListParams parameters = new() { BuildID = \"buildId\" };\n\nvar page = await client.Builds.Diagnostics.List(parameters);\nawait foreach (var item in page.Paginate())\n{\n    Console.WriteLine(item);\n}"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/builds/$BUILD_ID/diagnostics \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ output: 'url'; target: string; type: string; url: string; path?: string; } | { token: string; output: 'git'; ref: string; target: string; type: string; url: string; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "stl builds:target-outputs retrieve \\\n  --api-key 'My API Key' \\\n  --build-id build_id \\\n  --target node \\\n  --type source"
      },
      "php": {
        "method": "builds->targetOutputs->retrieve",
      ...
      "csharp": {
        "method": "Builds.TargetOutputs.Retrieve",
        "example": "TargetOutputRetrieveParams parameters = new()\n{\n    BuildID = \"build_id\",\n    Target = Target.Node,\n    Type = Type.Source,\n};\n\nvar targetOutput = await client.Builds.TargetOutputs.Retrieve(parameters);\n\nConsole.WriteLine(targetOutput);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/build_target_outputs \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { display_name: string; enable_ai_commit_messages: boolean; object: 'org'; slug: string; }[]; has_more: boolean; next_cursor?: string; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Orgs.List",
        "example": "OrgListParams parameters = new();\n\nvar orgs = await client.Orgs.List(parameters);\n\nConsole.WriteLine(orgs);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/orgs \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Orgs.Retrieve",
        "example": "OrgRetrieveParams parameters = new() { Org = \"org\" };\n\nvar org = await client.Orgs.Retrieve(parameters);\n\nConsole.WriteLine(org);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/orgs/$ORG \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "User.Retrieve",
        "example": "UserRetrieveParams parameters = new();\n\nvar user = await client.User.Retrieve(parameters);\n\nConsole.WriteLine(user);"
      },
      "http": {
        "example": "curl https://api.stainless.com/v0/user \\\n    -H \"Authorization: Bearer $STAINLESS_API_KEY\""
      }
    }
  }
];
