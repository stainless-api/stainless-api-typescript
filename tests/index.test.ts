...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['STAINLESS12_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Stainless12) => {
    ...
    test('default logLevel is warn', async () => {
      const client = new Stainless12({ apiKey: 'My API Key' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['STAINLESS12_LOG'] = 'debug';
      const client = new Stainless12({ logger: logger, apiKey: 'My API Key' });
    ...
    test('warn when env var level is invalid', async () => {
      ...
      process.env['STAINLESS12_LOG'] = 'not a log level';
      const client = new Stainless12({ logger: logger, apiKey: 'My API Key' });
      expect(client.logLevel).toBe('warn');
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'STAINLESS12_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Stainless12({ baseURL: 'http://localhost:5000/custom/path/', apiKey: 'My API Key' });
    ...
    afterEach(() => {
      process.env['STAINLESS12_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Stainless12({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['STAINLESS12_BASE_URL'] = 'https://example.com/from_env';
      const client = new Stainless12({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['STAINLESS12_BASE_URL'] = ''; // empty
      const client = new Stainless12({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.stainless.com');
    });

    test('blank env variable', () => {
      process.env['STAINLESS12_BASE_URL'] = '  '; // blank
      const client = new Stainless12({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://api.stainless.com');
    });
    ...
    test('env variable with environment', () => {
      ...
      expect(
        () => new Stainless12({ apiKey: 'My API Key', environment: 'production' }),
      ).toThrowErrorMatchingInlineSnapshot(
        `"Ambiguous URL; The \`baseURL\` option (or STAINLESS12_BASE_URL env var) and the \`environment\` option are given. If you want to use the environment you must pass baseURL: null"`,
      );
    ...
    test('in request options overridden by client options', () => {
      const client = new Stainless12({ apiKey: 'My API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['STAINLESS12_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Stainless12({ apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Stainless12({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Stainless12({ apiKey: 'My API Key' });
...
describe('retries', () => {
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Stainless12({ apiKey: 'My API Key', fetch: testFetch });
